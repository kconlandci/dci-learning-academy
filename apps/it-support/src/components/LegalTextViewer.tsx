    ...
    <div className="min-h-screen bg-white">
      <div className="sticky top-0 z-10 bg-white/95 backdrop-blur border-b border-gray-200 px-4 py-3">
        <div className="max-w-lg mx-auto flex items-center gap-3">
          <button onClick={() => window.history.length > 1 ? navigate(-1) : navigate("/")} aria-label="Go back" className="min-w-[48px] min-h-[48px] flex items-center justify-center -ml-2">
      ...
      <div className="max-w-lg mx-auto p-4 pb-12">
        <div className="text-sm text-gray-500 leading-relaxed whitespace-pre-line">{content}</div>
      </div>
    </div>
  );
}
