// ============================================================
// DCI IT Support Labs — Shared Lab Engine
// ============================================================
        ...
        <div className="max-w-lg mx-auto pt-8">
          ...
          <div className="bg-[#F5F5F5] rounded-xl p-4 mb-6">
            ...
            <div className="space-y-2 text-sm">
              <div className="flex justify-between text-green-400"><span>Perfect answers</span><span>{perfectCount}</span></div>
              <div className="flex justify-between text-yellow-600"><span>Partial answers</span><span>{partialCount}</span></div>
              <div className="flex justify-between text-red-400"><span>Wrong answers</span><span>{wrongCount}</span></div>
              {hintsUsed > 0 && (
          ...
          <div className="bg-[#F5F5F5] rounded-xl p-4 mb-6">
            ...
            <div className="flex flex-wrap gap-2">
              {manifest.toolRelevance.map((tool, i) => (
                <span key={i} className="px-2 py-1 rounded bg-gray-200 text-xs text-gray-500">{tool}</span>
              ))}
            </div>
          </div>
          {renderAfterResults?.()}
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-lg mx-auto p-4">
        <Renderer key={scenarioIndex} scenario={scenario} onSubmit={handleSubmit} phase={phase} feedbackResult={feedbackResult} />
      </div>
      {phase === "feedback" && (
