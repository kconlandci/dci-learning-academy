      ...
      <div className="min-h-screen bg-white p-4">
        <div className="max-w-lg mx-auto pt-8">
          ...
          <div className="flex items-center gap-3 mb-6">
            <div className="w-12 h-12 rounded-xl bg-[#2A7F6F]/10 flex items-center justify-center">
          ...
          <button
            ...
            className="w-full py-3.5 rounded-xl bg-[#2A7F6F] hover:bg-[#2A7F6F] text-white font-semibold text-lg transition-colors flex items-center justify-center gap-2"
          >
      ...
      <div className="min-h-screen bg-white p-4">
        <div className="max-w-lg mx-auto pt-8">
          ...
          <button
            onClick={onExit}
            aria-label="Back to catalog"
            className="w-full py-3 rounded-xl bg-[#2A7F6F] hover:bg-[#2A7F6F] text-white font-semibold transition-colors"
          >
            Back to Catalog
          </button>
        </div>
        ...
        <div className="sticky bottom-0 z-10 bg-white/95 backdrop-blur border-t border-gray-200 px-4 py-3">
          <div className="max-w-lg mx-auto">
            <button
              ...
              className="w-full py-3 rounded-xl bg-[#2A7F6F] hover:bg-[#2A7F6F] text-white font-semibold transition-colors flex items-center justify-center gap-2"
            >
