// ============================================================
// DCI Cloud Computing Labs Dev Preview Screen — /dev
    ...
    <div className="min-h-screen bg-white text-[#1A1A1A] p-4 pb-24">
      <div className="max-w-3xl mx-auto">
        <div className="flex items-center justify-between mb-6">
          <div>
            <h1 className="text-lg font-bold text-[#1A1A1A]">DCI Cloud Computing Labs Dev Preview</h1>
              ...
              <div className="flex items-start justify-between gap-4">
                <div>
                  ...
                  <div className="flex flex-wrap gap-2 mt-1 text-[10px] font-mono">
                    ...
                    <span className="px-1.5 py-0.5 rounded bg-[#F5F5F5] text-[#2A7F6F]">
                      {lab.rendererType}
                    </span>
                    <span
                ...
                <Link
                  to={`/lab/${lab.id}`}
                  className="shrink-0 px-3 py-1.5 rounded bg-[#2A7F6F] text-white text-xs font-semibold hover:bg-[#2A7F6F] transition-colors"
                >
                  Play
                </Link>
              </div>
