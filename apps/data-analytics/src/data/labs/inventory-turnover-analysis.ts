...
export const inventoryTurnoverAnalysisLab: LabManifest = LabManifestSchema.parse({
  "schemaVersion": "1.1",
  ...
  "description": "Practice inventory turnover analysis inside a realistic analytics workflow, choose the safest decision, and explain why it is the most trustworthy SQL or data move.",
  "estimatedMinutes": 18,
  "learningObjectives": [
    "Clarify the stakeholder need behind inventory turnover analysis.",
  ...
  "scenarios": [
    {
      "type": "toggle-config",
      "id": "inventory-turnover-analysis-scenario-1",
      "title": "Configure the default quality controls",
      "description": "You are preparing a shared asset for inventory turnover analysis. Set the defaults so the go-to-market lead gets trustworthy results without relying on tribal knowledge.",
      "targetSystem": "mart.daily_revenue.semantic_model",
      "items": [
        {
          "id": "grain-check",
      ...
      "feedback": {
        "perfect": "Great configuration. Inventory Turnover Analysis becomes safer to reuse when quality checks, null policies, and reviews are explicit.",
    ...
    {
      "type": "toggle-config",
      "id": "inventory-turnover-analysis-scenario-2",
      "title": "Set access and change controls",
      "description": "A wider audience wants self-service access to inventory turnover analysis. Configure the model so speed does not outrun governance.",
      "targetSystem": "mart.daily_revenue.reporting_view",
      "items": [
        {
          "id": "access-scope",
          "label": "Access Scope",
    ...
    {
      "type": "toggle-config",
      "id": "inventory-turnover-analysis-scenario-3",
      "title": "Tune the publish workflow",
      "description": "The team wants a faster release cycle for inventory turnover analysis. Configure the publish workflow so the team can move quickly without normalizing broken output.",
      "targetSystem": "mart.daily_revenue.publish_job",
      "items": [
        {
          "id": "test-suite",
  ...
  "hints": [
    "Start by naming the business grain that inventory turnover analysis should produce.",
  ...
  "careerInsight": "Analysts who can explain trends with clean SQL and defensible logic become the people leaders trust in decision meetings. Inventory Turnover Analysis is a common scenario in interviews, production reviews, and cross-functional planning.",
  "toolRelevance": [
    "DuckDB",
    "BigQuery",
    "Looker Studio"
