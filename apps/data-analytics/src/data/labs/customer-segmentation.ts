...
export const customerSegmentationLab: LabManifest = LabManifestSchema.parse({
  "schemaVersion": "1.1",
  ...
  "description": "Practice customer segmentation inside a realistic analytics workflow, choose the safest decision, and explain why it is the most trustworthy SQL or data move.",
  "estimatedMinutes": 14,
  "learningObjectives": [
    "Clarify the stakeholder need behind customer segmentation.",
  ...
  "scenarios": [
    {
      ...
      "id": "customer-segmentation-scenario-1",
      "title": "Investigate the surprising output",
      "objective": "A go-to-market lead flagged a surprising result while reviewing customer segmentation. Inspect the evidence and decide the best next step before the metric is shared more widely.",
      "investigationData": [
        {
          "id": "source-query",
    ...
    {
      "type": "investigate-decide",
      "id": "customer-segmentation-scenario-2",
      "title": "Resolve the freshness conflict",
      "objective": "Two teams are quoting different outputs for customer segmentation. Review the evidence and decide how to respond.",
      "investigationData": [
        {
          "id": "source-dashboard",
    ...
    {
      "type": "investigate-decide",
      "id": "customer-segmentation-scenario-3",
      "title": "Decide how to close the incident",
      "objective": "You have narrowed the issue behind customer segmentation. Review the final evidence and choose the best closeout action.",
      "investigationData": [
        {
  ...
  "hints": [
    "Start by naming the business grain that customer segmentation should produce.",
  ...
  "careerInsight": "Analysts who can explain trends with clean SQL and defensible logic become the people leaders trust in decision meetings. Customer Segmentation is a common scenario in interviews, production reviews, and cross-functional planning.",
  "toolRelevance": [
    "DuckDB",
    "BigQuery",
    "Looker Studio"
