...
export const correlatedSubqueriesLab: LabManifest = LabManifestSchema.parse({
  "schemaVersion": "1.1",
  ...
  "description": "Practice correlated subqueries inside a realistic analytics workflow, choose the safest decision, and explain why it is the most trustworthy SQL or data move.",
  "estimatedMinutes": 18,
  "learningObjectives": [
    "Clarify the stakeholder need behind correlated subqueries.",
  ...
  "scenarios": [
    {
      ...
      "id": "correlated-subqueries-scenario-1",
      "title": "Triage the broken result",
      "description": "A delivery team escalated correlated subqueries after seeing an unexpected spike. Classify the issue, pick the right remediation, and explain your decision.",
      "evidence": [
        {
          "type": "query output",
          "content": "The warehouse.customers result set doubled after a new dimension join was released."
        },
        {
          "type": "quality alert",
        ...
        },
        {
          ...
          "content": "The analytics lead needs a trusted answer before tomorrow's review."
        }
      ],
      "classifications": [
        {
    ...
    {
      "type": "triage-remediate",
      "id": "correlated-subqueries-scenario-2",
      "title": "Classify the stale dashboard",
      "description": "A shared dashboard built on correlated subqueries is stale after a failed refresh. Decide how to classify and remediate the issue.",
      "evidence": [
        {
          "type": "refresh log",
    ...
    {
      "type": "triage-remediate",
      "id": "correlated-subqueries-scenario-3",
      "title": "Close the definition mismatch",
      "description": "A metric built for correlated subqueries changed meaning after a silent definition update. Classify the issue and choose the best remediation.",
      "evidence": [
        {
          "type": "change note",
        ...
        {
          "type": "owner feedback",
          "content": "The analytics lead wants a correction, a root-cause note, and a safer handoff next time."
        }
      ],
      "classifications": [
        {
  ...
  "hints": [
    "Start by naming the business grain that correlated subqueries should produce.",
  ...
  "careerInsight": "Reliable SQL fundamentals are the fastest way to become useful on analytics, reporting, and data engineering teams. Correlated Subqueries is a common scenario in interviews, production reviews, and cross-functional planning.",
  "toolRelevance": [
    "PostgreSQL",
    "SQLite",
    "DBeaver"
