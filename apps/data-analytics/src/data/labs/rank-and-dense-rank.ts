...
export const rankAndDenseRankLab: LabManifest = LabManifestSchema.parse({
  "schemaVersion": "1.1",
  "id": "rank-and-dense-rank",
  "version": 1,
  ...
  "description": "Practice rank and dense rank inside a realistic analytics workflow, choose the safest decision, and explain why it is the most trustworthy SQL or data move.",
  "estimatedMinutes": 10,
  "learningObjectives": [
    "Clarify the stakeholder need behind rank and dense rank.",
  ...
  "prerequisites": [
    {
      "labId": "median-with-window-functions",
      "minScore": 60
    }
  ],
  ...
  "scenarios": [
    {
      ...
      "id": "rank-and-dense-rank-scenario-1",
      "title": "Triage the broken result",
      "description": "A delivery team escalated rank and dense rank after seeing an unexpected spike. Classify the issue, pick the right remediation, and explain your decision.",
      "evidence": [
        {
          "type": "query output",
    ...
    {
      "type": "triage-remediate",
      "id": "rank-and-dense-rank-scenario-2",
      "title": "Classify the stale dashboard",
      "description": "A shared dashboard built on rank and dense rank is stale after a failed refresh. Decide how to classify and remediate the issue.",
      "evidence": [
        {
          "type": "refresh log",
    ...
    {
      "type": "triage-remediate",
      "id": "rank-and-dense-rank-scenario-3",
      "title": "Close the definition mismatch",
      "description": "A metric built for rank and dense rank changed meaning after a silent definition update. Classify the issue and choose the best remediation.",
      "evidence": [
        {
          "type": "change note",
  ...
  "hints": [
    "Start by naming the business grain that rank and dense rank should produce.",
  ...
  "careerInsight": "Analysts who can explain trends with clean SQL and defensible logic become the people leaders trust in decision meetings. Rank and Dense Rank is a common scenario in interviews, production reviews, and cross-functional planning.",
  "toolRelevance": [
    "DuckDB",
    "BigQuery",
    "Looker Studio"
