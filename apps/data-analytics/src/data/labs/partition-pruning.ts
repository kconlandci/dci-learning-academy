...
export const partitionPruningLab: LabManifest = LabManifestSchema.parse({
  "schemaVersion": "1.1",
  ...
  "description": "Practice partition pruning inside a realistic analytics workflow, choose the safest decision, and explain why it is the most trustworthy SQL or data move.",
  "estimatedMinutes": 10,
  "learningObjectives": [
    "Clarify the stakeholder need behind partition pruning.",
  ...
  "scenarios": [
    {
      ...
      "id": "partition-pruning-scenario-1",
      "title": "Triage the broken result",
      "description": "A delivery team escalated partition pruning after seeing an unexpected spike. Classify the issue, pick the right remediation, and explain your decision.",
      "evidence": [
        {
          "type": "query output",
    ...
    {
      "type": "triage-remediate",
      "id": "partition-pruning-scenario-2",
      "title": "Classify the stale dashboard",
      "description": "A shared dashboard built on partition pruning is stale after a failed refresh. Decide how to classify and remediate the issue.",
      "evidence": [
        {
          "type": "refresh log",
    ...
    {
      "type": "triage-remediate",
      "id": "partition-pruning-scenario-3",
      "title": "Close the definition mismatch",
      "description": "A metric built for partition pruning changed meaning after a silent definition update. Classify the issue and choose the best remediation.",
      "evidence": [
        {
          "type": "change note",
  ...
  "hints": [
    "Start by naming the business grain that partition pruning should produce.",
  ...
  "careerInsight": "Advanced analytics work often separates solid SQL users from the engineers who can keep an entire warehouse fast and stable. Partition Pruning is a common scenario in interviews, production reviews, and cross-functional planning.",
  "toolRelevance": [
    "EXPLAIN plans",
    "Snowflake",
    "PostgreSQL"
