...
export const surrogateKeyGenerationLab: LabManifest = LabManifestSchema.parse({
  "schemaVersion": "1.1",
  "id": "surrogate-key-generation",
  "version": 1,
  ...
  "description": "Practice surrogate key generation inside a realistic analytics workflow, choose the safest decision, and explain why it is the most trustworthy SQL or data move.",
  "estimatedMinutes": 14,
  "learningObjectives": [
    "Clarify the stakeholder need behind surrogate key generation.",
  ...
  "prerequisites": [
    {
      "labId": "full-refresh-vs-incremental",
      "minScore": 60
    }
  ],
  ...
  "scenarios": [
    {
      ...
      "id": "surrogate-key-generation-scenario-1",
      "title": "Triage the broken result",
      "description": "A delivery team escalated surrogate key generation after seeing an unexpected spike. Classify the issue, pick the right remediation, and explain your decision.",
      "evidence": [
        {
          "type": "query output",
          "content": "The staging.raw_customers result set doubled after a new dimension join was released."
        },
        {
          "type": "quality alert",
        ...
        },
        {
          ...
          "content": "The analytics engineer needs a trusted answer before tomorrow's review."
        }
      ],
      "classifications": [
        {
    ...
    {
      "type": "triage-remediate",
      "id": "surrogate-key-generation-scenario-2",
      "title": "Classify the stale dashboard",
      "description": "A shared dashboard built on surrogate key generation is stale after a failed refresh. Decide how to classify and remediate the issue.",
      "evidence": [
        {
          "type": "refresh log",
    ...
    {
      "type": "triage-remediate",
      "id": "surrogate-key-generation-scenario-3",
      "title": "Close the definition mismatch",
      "description": "A metric built for surrogate key generation changed meaning after a silent definition update. Classify the issue and choose the best remediation.",
      "evidence": [
        {
          "type": "change note",
        ...
        {
          "type": "owner feedback",
          "content": "The analytics engineer wants a correction, a root-cause note, and a safer handoff next time."
        }
      ],
      "classifications": [
        {
  ...
  "hints": [
    "Start by naming the business grain that surrogate key generation should produce.",
  ...
  "careerInsight": "Pipeline teams create trust at scale by spotting data quality risk before it turns into broken reporting or missed SLAs. Surrogate Key Generation is a common scenario in interviews, production reviews, and cross-functional planning.",
  "toolRelevance": [
    "dbt",
    "Airflow",
    "BigQuery"
