...
export const groupByBasicsLab: LabManifest = LabManifestSchema.parse({
  "schemaVersion": "1.1",
  "id": "group-by-basics",
  "version": 1,
  ...
  "description": "Practice group by basics inside a realistic analytics workflow, choose the safest decision, and explain why it is the most trustworthy SQL or data move.",
  "estimatedMinutes": 14,
  "learningObjectives": [
    "Clarify the stakeholder need behind group by basics.",
  ...
  "scenarios": [
    {
      "type": "toggle-config",
      "id": "group-by-basics-scenario-1",
      "title": "Configure the default quality controls",
      "description": "You are preparing a shared asset for group by basics. Set the defaults so the analytics lead gets trustworthy results without relying on tribal knowledge.",
      "targetSystem": "warehouse.customers.semantic_model",
      "items": [
        {
          "id": "grain-check",
      ...
      "feedback": {
        "perfect": "Great configuration. Group By Basics becomes safer to reuse when quality checks, null policies, and reviews are explicit.",
    ...
    {
      "type": "toggle-config",
      "id": "group-by-basics-scenario-2",
      "title": "Set access and change controls",
      "description": "A wider audience wants self-service access to group by basics. Configure the model so speed does not outrun governance.",
      "targetSystem": "warehouse.customers.reporting_view",
      "items": [
        {
          "id": "access-scope",
          "label": "Access Scope",
    ...
    {
      "type": "toggle-config",
      "id": "group-by-basics-scenario-3",
      "title": "Tune the publish workflow",
      "description": "The team wants a faster release cycle for group by basics. Configure the publish workflow so the team can move quickly without normalizing broken output.",
      "targetSystem": "warehouse.customers.publish_job",
      "items": [
        {
          "id": "test-suite",
  ...
  "hints": [
    "Start by naming the business grain that group by basics should produce.",
  ...
  "careerInsight": "Reliable SQL fundamentals are the fastest way to become useful on analytics, reporting, and data engineering teams. Group By Basics is a common scenario in interviews, production reviews, and cross-functional planning.",
  "toolRelevance": [
    "PostgreSQL",
    "SQLite",
    "DBeaver"
