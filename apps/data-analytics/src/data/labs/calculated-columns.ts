...
export const calculatedColumnsLab: LabManifest = LabManifestSchema.parse({
  "schemaVersion": "1.1",
  ...
  "description": "Practice calculated columns inside a realistic analytics workflow, choose the safest decision, and explain why it is the most trustworthy SQL or data move.",
  "estimatedMinutes": 10,
  "learningObjectives": [
    "Clarify the stakeholder need behind calculated columns.",
  ...
  "scenarios": [
    {
      ...
      "id": "calculated-columns-scenario-1",
      "title": "Triage the broken result",
      "description": "A delivery team escalated calculated columns after seeing an unexpected spike. Classify the issue, pick the right remediation, and explain your decision.",
      "evidence": [
        {
          "type": "query output",
    ...
    {
      "type": "triage-remediate",
      "id": "calculated-columns-scenario-2",
      "title": "Classify the stale dashboard",
      "description": "A shared dashboard built on calculated columns is stale after a failed refresh. Decide how to classify and remediate the issue.",
      "evidence": [
        {
          "type": "refresh log",
    ...
    {
      "type": "triage-remediate",
      "id": "calculated-columns-scenario-3",
      "title": "Close the definition mismatch",
      "description": "A metric built for calculated columns changed meaning after a silent definition update. Classify the issue and choose the best remediation.",
      "evidence": [
        {
          "type": "change note",
  ...
  "hints": [
    "Start by naming the business grain that calculated columns should produce.",
  ...
  "careerInsight": "Reliable SQL fundamentals are the fastest way to become useful on analytics, reporting, and data engineering teams. Calculated Columns is a common scenario in interviews, production reviews, and cross-functional planning.",
  "toolRelevance": [
    "PostgreSQL",
    "SQLite",
    "DBeaver"
