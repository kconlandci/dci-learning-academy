...
export const primaryVsSurrogateKeysLab: LabManifest = LabManifestSchema.parse({
  "schemaVersion": "1.1",
  "id": "primary-vs-surrogate-keys",
  "version": 1,
  "title": "Primary vs Surrogate Keys",
  "tier": "beginner",
  ...
  "description": "Practice primary vs surrogate keys inside a realistic analytics workflow, choose the safest decision, and explain why it is the most trustworthy SQL or data move.",
  "estimatedMinutes": 10,
  "learningObjectives": [
    "Clarify the stakeholder need behind primary vs surrogate keys.",
  ...
  "prerequisites": [
    {
      "labId": "entity-relationship-mapping",
      "minScore": 60
    }
  ],
  ...
  "scenarios": [
    {
      ...
      "id": "primary-vs-surrogate-keys-scenario-1",
      "title": "Investigate the surprising output",
      "objective": "A data architect flagged a surprising result while reviewing primary vs surrogate keys. Inspect the evidence and decide the best next step before the metric is shared more widely.",
      "investigationData": [
        {
          "id": "source-query",
          "label": "Query Result Sample",
          "content": "Rows from core.subscription_events show a 14% jump after a new join was added yesterday. Distinct entity count increased only 1%.",
          "isCritical": true
        },
        {
          "id": "source-note",
        ...
        },
        {
          ...
          "content": "The data architect needs a reliable explanation before presenting this number to leadership."
        }
      ],
      "actions": [
        {
    ...
    {
      "type": "investigate-decide",
      "id": "primary-vs-surrogate-keys-scenario-2",
      "title": "Resolve the freshness conflict",
      "objective": "Two teams are quoting different outputs for primary vs surrogate keys. Review the evidence and decide how to respond.",
      "investigationData": [
        {
          "id": "source-dashboard",
        ...
        },
        {
          "id": "source-chat",
          "label": "Team Chat",
          "content": "The data architect asks whether the 08:00 dashboard can still be used for today's review."
        }
      ],
      "actions": [
        {
    ...
    {
      "type": "investigate-decide",
      "id": "primary-vs-surrogate-keys-scenario-3",
      "title": "Decide how to close the incident",
      "objective": "You have narrowed the issue behind primary vs surrogate keys. Review the final evidence and choose the best closeout action.",
      "investigationData": [
        {
  ...
  "hints": [
    "Start by naming the business grain that primary vs surrogate keys should produce.",
  ...
  "careerInsight": "Strong data modeling judgment helps teams avoid duplicated logic, brittle pipelines, and expensive rework. Primary vs Surrogate Keys is a common scenario in interviews, production reviews, and cross-functional planning.",
  "toolRelevance": [
    "dbdiagram.io",
    "PostgreSQL",
    "Flyway"
