...
export const uniqueConstraintsLab: LabManifest = LabManifestSchema.parse({
  "schemaVersion": "1.1",
  ...
  "description": "Practice unique constraints inside a realistic analytics workflow, choose the safest decision, and explain why it is the most trustworthy SQL or data move.",
  "estimatedMinutes": 10,
  "learningObjectives": [
    "Clarify the stakeholder need behind unique constraints.",
  ...
  "scenarios": [
    {
      ...
      "id": "unique-constraints-scenario-1",
      "title": "Choose the strongest SQL approach",
      "context": "platform engineer needs a reliable answer for unique constraints before the weekly review. Pick the action that keeps the query auditable and the result grain stable under deadline pressure.",
      "displayFields": [
        {
          "label": "Dataset",
          "value": "core.order_facts"
        },
        {
          "label": "Deadline",
          "value": "30 minutes",
      ...
      "feedback": {
        "perfect": "Excellent. Unique Constraints is strongest when you keep the grain explicit and validate the joins before sharing a metric.",
        ...
        "wrong": "That choice adds avoidable risk. For unique constraints, the best move is the option that stays reviewable and grain-aware."
      }
    },
    {
      "type": "action-rationale",
      "id": "unique-constraints-scenario-2",
      "title": "Handle the stakeholder follow-up",
      "context": "After your first draft, the platform engineer asks for one more slice of unique constraints by region. Decide how to respond without turning a clean query into a fragile one-off.",
      "displayFields": [
        {
          "label": "Current asset",
          "value": "unique-constraints_draft.sql"
        },
        {
    ...
    {
      "type": "action-rationale",
      "id": "unique-constraints-scenario-3",
      "title": "Explain why the result is trustworthy",
      "context": "You are presenting unique constraints in a team review. Choose the explanation that best demonstrates sound analytics judgment.",
      "displayFields": [
        {
          "label": "Audience",
  ...
  "hints": [
    "Start by naming the business grain that unique constraints should produce.",
  ...
  "careerInsight": "Strong data modeling judgment helps teams avoid duplicated logic, brittle pipelines, and expensive rework. Unique Constraints is a common scenario in interviews, production reviews, and cross-functional planning.",
  "toolRelevance": [
    "dbdiagram.io",
    "PostgreSQL",
    "Flyway"
