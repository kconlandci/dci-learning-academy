...
export const inventoryDashboardStorytellingLab: LabManifest = LabManifestSchema.parse({
  "schemaVersion": "1.1",
  "id": "inventory-dashboard-storytelling",
  "version": 1,
  "title": "Inventory Dashboard Storytelling",
  "tier": "intermediate",
  ...
  "description": "Practice inventory dashboard storytelling inside a realistic analytics workflow, choose the safest decision, and explain why it is the most trustworthy SQL or data move.",
  "estimatedMinutes": 14,
  "learningObjectives": [
    "Clarify the stakeholder need behind inventory dashboard storytelling.",
  ...
  "scenarios": [
    {
      ...
      "id": "inventory-dashboard-storytelling-scenario-1",
      "title": "Choose the strongest SQL approach",
      "context": "sales director needs a reliable answer for inventory dashboard storytelling before the weekly review. Pick the action that keeps the query auditable and the result grain stable under deadline pressure.",
      "displayFields": [
        {
          "label": "Dataset",
          "value": "bi.executive_scorecard"
        },
        {
          "label": "Deadline",
          "value": "30 minutes",
      ...
      "feedback": {
        "perfect": "Excellent. Inventory Dashboard Storytelling is strongest when you keep the grain explicit and validate the joins before sharing a metric.",
        ...
        "wrong": "That choice adds avoidable risk. For inventory dashboard storytelling, the best move is the option that stays reviewable and grain-aware."
      }
    },
    {
      "type": "action-rationale",
      "id": "inventory-dashboard-storytelling-scenario-2",
      "title": "Handle the stakeholder follow-up",
      "context": "After your first draft, the sales director asks for one more slice of inventory dashboard storytelling by region. Decide how to respond without turning a clean query into a fragile one-off.",
      "displayFields": [
        {
          "label": "Current asset",
          "value": "inventory-dashboard-storytelling_draft.sql"
        },
        {
    ...
    {
      "type": "action-rationale",
      "id": "inventory-dashboard-storytelling-scenario-3",
      "title": "Explain why the result is trustworthy",
      "context": "You are presenting inventory dashboard storytelling in a team review. Choose the explanation that best demonstrates sound analytics judgment.",
      "displayFields": [
        {
          "label": "Audience",
  ...
  "hints": [
    "Start by naming the business grain that inventory dashboard storytelling should produce.",
  ...
  "careerInsight": "Good BI work is not just chart building; it is metric definition, stakeholder alignment, and clear storytelling. Inventory Dashboard Storytelling is a common scenario in interviews, production reviews, and cross-functional planning.",
  "toolRelevance": [
    "Looker",
    "Power BI",
    "Tableau"
