...
export const confidenceIntervalPrepLab: LabManifest = LabManifestSchema.parse({
  "schemaVersion": "1.1",
  "id": "confidence-interval-prep",
  "version": 1,
  "title": "Confidence Interval Prep",
  "tier": "advanced",
  "track": "Data Analysis",
  ...
  "description": "Practice confidence interval prep inside a realistic analytics workflow, choose the safest decision, and explain why it is the most trustworthy SQL or data move.",
  "estimatedMinutes": 18,
  "learningObjectives": [
    "Clarify the stakeholder need behind confidence interval prep.",
  ...
  "scenarios": [
    {
      ...
      "id": "confidence-interval-prep-scenario-1",
      "title": "Triage the broken result",
      "description": "A delivery team escalated confidence interval prep after seeing an unexpected spike. Classify the issue, pick the right remediation, and explain your decision.",
      "evidence": [
        {
          "type": "query output",
          "content": "The mart.customer_cohorts result set doubled after a new dimension join was released."
        },
        {
          "type": "quality alert",
        ...
        },
        {
          ...
          "content": "The growth analyst needs a trusted answer before tomorrow's review."
        }
      ],
      "classifications": [
        {
    ...
    {
      "type": "triage-remediate",
      "id": "confidence-interval-prep-scenario-2",
      "title": "Classify the stale dashboard",
      "description": "A shared dashboard built on confidence interval prep is stale after a failed refresh. Decide how to classify and remediate the issue.",
      "evidence": [
        {
          "type": "refresh log",
    ...
    {
      "type": "triage-remediate",
      "id": "confidence-interval-prep-scenario-3",
      "title": "Close the definition mismatch",
      "description": "A metric built for confidence interval prep changed meaning after a silent definition update. Classify the issue and choose the best remediation.",
      "evidence": [
        {
          "type": "change note",
        ...
        {
          "type": "owner feedback",
          "content": "The growth analyst wants a correction, a root-cause note, and a safer handoff next time."
        }
      ],
      "classifications": [
        {
  ...
  "hints": [
    "Start by naming the business grain that confidence interval prep should produce.",
  ...
  "careerInsight": "Analysts who can explain trends with clean SQL and defensible logic become the people leaders trust in decision meetings. Confidence Interval Prep is a common scenario in interviews, production reviews, and cross-functional planning.",
  "toolRelevance": [
    "DuckDB",
    "BigQuery",
    "Looker Studio"
