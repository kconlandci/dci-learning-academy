...
export const narrativeInsightsLab: LabManifest = LabManifestSchema.parse({
  "schemaVersion": "1.1",
  ...
  "description": "Practice narrative insights inside a realistic analytics workflow, choose the safest decision, and explain why it is the most trustworthy SQL or data move.",
  "estimatedMinutes": 18,
  "learningObjectives": [
    "Clarify the stakeholder need behind narrative insights.",
  ...
  "prerequisites": [
    {
      "labId": "alert-threshold-reporting",
      "minScore": 60
    }
  ],
  ...
  "scenarios": [
    {
      ...
      "id": "narrative-insights-scenario-1",
      "title": "Choose the strongest SQL approach",
      "context": "customer support lead needs a reliable answer for narrative insights before the weekly review. Pick the action that keeps the query auditable and the result grain stable under deadline pressure.",
      "displayFields": [
        {
          "label": "Dataset",
      ...
      "feedback": {
        "perfect": "Excellent. Narrative Insights is strongest when you keep the grain explicit and validate the joins before sharing a metric.",
        ...
        "wrong": "That choice adds avoidable risk. For narrative insights, the best move is the option that stays reviewable and grain-aware."
      }
    },
    {
      "type": "action-rationale",
      "id": "narrative-insights-scenario-2",
      "title": "Handle the stakeholder follow-up",
      "context": "After your first draft, the customer support lead asks for one more slice of narrative insights by region. Decide how to respond without turning a clean query into a fragile one-off.",
      "displayFields": [
        {
          "label": "Current asset",
          "value": "narrative-insights_draft.sql"
        },
        {
    ...
    {
      "type": "action-rationale",
      "id": "narrative-insights-scenario-3",
      "title": "Explain why the result is trustworthy",
      "context": "You are presenting narrative insights in a team review. Choose the explanation that best demonstrates sound analytics judgment.",
      "displayFields": [
        {
          "label": "Audience",
  ...
  "hints": [
    "Start by naming the business grain that narrative insights should produce.",
  ...
  "careerInsight": "Good BI work is not just chart building; it is metric definition, stakeholder alignment, and clear storytelling. Narrative Insights is a common scenario in interviews, production reviews, and cross-functional planning.",
  "toolRelevance": [
    "Looker",
    "Power BI",
    "Tableau"
