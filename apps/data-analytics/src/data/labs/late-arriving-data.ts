...
export const lateArrivingDataLab: LabManifest = LabManifestSchema.parse({
  "schemaVersion": "1.1",
  ...
  "description": "Practice late arriving data inside a realistic analytics workflow, choose the safest decision, and explain why it is the most trustworthy SQL or data move.",
  "estimatedMinutes": 14,
  "learningObjectives": [
    "Clarify the stakeholder need behind late arriving data.",
  ...
  "scenarios": [
    {
      ...
      "id": "late-arriving-data-scenario-1",
      "title": "Choose the strongest SQL approach",
      "context": "platform manager needs a reliable answer for late arriving data before the weekly review. Pick the action that keeps the query auditable and the result grain stable under deadline pressure.",
      "displayFields": [
        {
          "label": "Dataset",
          "value": "staging.raw_customers"
        },
        {
          "label": "Deadline",
          "value": "30 minutes",
      ...
      "feedback": {
        "perfect": "Excellent. Late Arriving Data is strongest when you keep the grain explicit and validate the joins before sharing a metric.",
        ...
        "wrong": "That choice adds avoidable risk. For late arriving data, the best move is the option that stays reviewable and grain-aware."
      }
    },
    {
      "type": "action-rationale",
      "id": "late-arriving-data-scenario-2",
      "title": "Handle the stakeholder follow-up",
      "context": "After your first draft, the platform manager asks for one more slice of late arriving data by region. Decide how to respond without turning a clean query into a fragile one-off.",
      "displayFields": [
        {
          "label": "Current asset",
          "value": "late-arriving-data_draft.sql"
        },
        {
    ...
    {
      "type": "action-rationale",
      "id": "late-arriving-data-scenario-3",
      "title": "Explain why the result is trustworthy",
      "context": "You are presenting late arriving data in a team review. Choose the explanation that best demonstrates sound analytics judgment.",
      "displayFields": [
        {
          "label": "Audience",
  ...
  "hints": [
    "Start by naming the business grain that late arriving data should produce.",
  ...
  "careerInsight": "Pipeline teams create trust at scale by spotting data quality risk before it turns into broken reporting or missed SLAs. Late Arriving Data is a common scenario in interviews, production reviews, and cross-functional planning.",
  "toolRelevance": [
    "dbt",
    "Airflow",
    "BigQuery"
