...
export const stakeholderMetricDefinitionsLab: LabManifest = LabManifestSchema.parse({
  "schemaVersion": "1.1",
  "id": "stakeholder-metric-definitions",
  "version": 1,
  "title": "Stakeholder Metric Definitions",
  "tier": "intermediate",
  ...
  "description": "Practice stakeholder metric definitions inside a realistic analytics workflow, choose the safest decision, and explain why it is the most trustworthy SQL or data move.",
  "estimatedMinutes": 14,
  "learningObjectives": [
    "Clarify the stakeholder need behind stakeholder metric definitions.",
  ...
  "prerequisites": [
    {
      "labId": "inventory-dashboard-storytelling",
      "minScore": 60
    }
  ],
  ...
  "scenarios": [
    {
      "type": "toggle-config",
      "id": "stakeholder-metric-definitions-scenario-1",
      "title": "Configure the default quality controls",
      "description": "You are preparing a shared asset for stakeholder metric definitions. Set the defaults so the BI manager gets trustworthy results without relying on tribal knowledge.",
      "targetSystem": "bi.sales_pipeline.semantic_model",
      "items": [
        {
          "id": "grain-check",
      ...
      "feedback": {
        "perfect": "Great configuration. Stakeholder Metric Definitions becomes safer to reuse when quality checks, null policies, and reviews are explicit.",
    ...
    {
      "type": "toggle-config",
      "id": "stakeholder-metric-definitions-scenario-2",
      "title": "Set access and change controls",
      "description": "A wider audience wants self-service access to stakeholder metric definitions. Configure the model so speed does not outrun governance.",
      "targetSystem": "bi.sales_pipeline.reporting_view",
      "items": [
        {
          "id": "access-scope",
          "label": "Access Scope",
    ...
    {
      "type": "toggle-config",
      "id": "stakeholder-metric-definitions-scenario-3",
      "title": "Tune the publish workflow",
      "description": "The team wants a faster release cycle for stakeholder metric definitions. Configure the publish workflow so the team can move quickly without normalizing broken output.",
      "targetSystem": "bi.sales_pipeline.publish_job",
      "items": [
        {
          "id": "test-suite",
  ...
  "hints": [
    "Start by naming the business grain that stakeholder metric definitions should produce.",
  ...
  "careerInsight": "Good BI work is not just chart building; it is metric definition, stakeholder alignment, and clear storytelling. Stakeholder Metric Definitions is a common scenario in interviews, production reviews, and cross-functional planning.",
  "toolRelevance": [
    "Looker",
    "Power BI",
    "Tableau"
