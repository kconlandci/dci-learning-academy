...
export const executiveKpiScorecardLab: LabManifest = LabManifestSchema.parse({
  "schemaVersion": "1.1",
  "id": "executive-kpi-scorecard",
  "version": 1,
  ...
  "description": "Practice executive kpi scorecard inside a realistic analytics workflow, choose the safest decision, and explain why it is the most trustworthy SQL or data move.",
  "estimatedMinutes": 10,
  "learningObjectives": [
    "Clarify the stakeholder need behind executive kpi scorecard.",
  ...
  "scenarios": [
    {
      ...
      "id": "executive-kpi-scorecard-scenario-1",
      "title": "Investigate the surprising output",
      "objective": "A BI manager flagged a surprising result while reviewing executive kpi scorecard. Inspect the evidence and decide the best next step before the metric is shared more widely.",
      "investigationData": [
        {
          "id": "source-query",
          "label": "Query Result Sample",
          "content": "Rows from bi.support_metrics show a 14% jump after a new join was added yesterday. Distinct entity count increased only 1%.",
          "isCritical": true
        },
        {
          "id": "source-note",
        ...
        },
        {
          ...
          "content": "The BI manager needs a reliable explanation before presenting this number to leadership."
        }
      ],
      "actions": [
        {
    ...
    {
      "type": "investigate-decide",
      "id": "executive-kpi-scorecard-scenario-2",
      "title": "Resolve the freshness conflict",
      "objective": "Two teams are quoting different outputs for executive kpi scorecard. Review the evidence and decide how to respond.",
      "investigationData": [
        {
          "id": "source-dashboard",
        ...
        },
        {
          "id": "source-chat",
          "label": "Team Chat",
          "content": "The BI manager asks whether the 08:00 dashboard can still be used for today's review."
        }
      ],
      "actions": [
        {
    ...
    {
      "type": "investigate-decide",
      "id": "executive-kpi-scorecard-scenario-3",
      "title": "Decide how to close the incident",
      "objective": "You have narrowed the issue behind executive kpi scorecard. Review the final evidence and choose the best closeout action.",
      "investigationData": [
        {
  ...
  "hints": [
    "Start by naming the business grain that executive kpi scorecard should produce.",
  ...
  "careerInsight": "Good BI work is not just chart building; it is metric definition, stakeholder alignment, and clear storytelling. Executive KPI Scorecard is a common scenario in interviews, production reviews, and cross-functional planning.",
  "toolRelevance": [
    "Looker",
    "Power BI",
    "Tableau"
