...
export const typeCastingFailuresLab: LabManifest = LabManifestSchema.parse({
  "schemaVersion": "1.1",
  "id": "type-casting-failures",
  "version": 1,
  "title": "Type Casting Failures",
  "tier": "beginner",
  ...
  "description": "Practice type casting failures inside a realistic analytics workflow, choose the safest decision, and explain why it is the most trustworthy SQL or data move.",
  "estimatedMinutes": 10,
  "learningObjectives": [
    "Clarify the stakeholder need behind type casting failures.",
  ...
  "scenarios": [
    {
      ...
      "id": "type-casting-failures-scenario-1",
      "title": "Triage the broken result",
      "description": "A delivery team escalated type casting failures after seeing an unexpected spike. Classify the issue, pick the right remediation, and explain your decision.",
      "evidence": [
        {
          "type": "query output",
          "content": "The staging.raw_orders result set doubled after a new dimension join was released."
        },
        {
          "type": "quality alert",
        ...
        },
        {
          ...
          "content": "The platform manager needs a trusted answer before tomorrow's review."
        }
      ],
      "classifications": [
        {
    ...
    {
      "type": "triage-remediate",
      "id": "type-casting-failures-scenario-2",
      "title": "Classify the stale dashboard",
      "description": "A shared dashboard built on type casting failures is stale after a failed refresh. Decide how to classify and remediate the issue.",
      "evidence": [
        {
          "type": "refresh log",
    ...
    {
      "type": "triage-remediate",
      "id": "type-casting-failures-scenario-3",
      "title": "Close the definition mismatch",
      "description": "A metric built for type casting failures changed meaning after a silent definition update. Classify the issue and choose the best remediation.",
      "evidence": [
        {
          "type": "change note",
        ...
        {
          "type": "owner feedback",
          "content": "The platform manager wants a correction, a root-cause note, and a safer handoff next time."
        }
      ],
      "classifications": [
        {
  ...
  "hints": [
    "Start by naming the business grain that type casting failures should produce.",
  ...
  "careerInsight": "Pipeline teams create trust at scale by spotting data quality risk before it turns into broken reporting or missed SLAs. Type Casting Failures is a common scenario in interviews, production reviews, and cross-functional planning.",
  "toolRelevance": [
    "dbt",
    "Airflow",
    "BigQuery"
