...
export const selectBasicsLab: LabManifest = LabManifestSchema.parse({
  "schemaVersion": "1.1",
  "id": "select-basics",
  "version": 1,
  "title": "Select Basics",
  ...
  "description": "Practice select basics inside a realistic analytics workflow, choose the safest decision, and explain why it is the most trustworthy SQL or data move.",
  "estimatedMinutes": 10,
  "learningObjectives": [
    "Clarify the stakeholder need behind select basics.",
  ...
  "scenarios": [
    {
      ...
      "id": "select-basics-scenario-1",
      "title": "Choose the strongest SQL approach",
      "context": "operations manager needs a reliable answer for select basics before the weekly review. Pick the action that keeps the query auditable and the result grain stable under deadline pressure.",
      "displayFields": [
        {
          "label": "Dataset",
      ...
      "feedback": {
        "perfect": "Excellent. Select Basics is strongest when you keep the grain explicit and validate the joins before sharing a metric.",
        ...
        "wrong": "That choice adds avoidable risk. For select basics, the best move is the option that stays reviewable and grain-aware."
      }
    },
    {
      "type": "action-rationale",
      "id": "select-basics-scenario-2",
      "title": "Handle the stakeholder follow-up",
      "context": "After your first draft, the operations manager asks for one more slice of select basics by region. Decide how to respond without turning a clean query into a fragile one-off.",
      "displayFields": [
        {
          "label": "Current asset",
          "value": "select-basics_draft.sql"
        },
        {
    ...
    {
      "type": "action-rationale",
      "id": "select-basics-scenario-3",
      "title": "Explain why the result is trustworthy",
      "context": "You are presenting select basics in a team review. Choose the explanation that best demonstrates sound analytics judgment.",
      "displayFields": [
        {
          "label": "Audience",
  ...
  "hints": [
    "Start by naming the business grain that select basics should produce.",
  ...
  "careerInsight": "Reliable SQL fundamentals are the fastest way to become useful on analytics, reporting, and data engineering teams. Select Basics is a common scenario in interviews, production reviews, and cross-functional planning.",
  "toolRelevance": [
    "PostgreSQL",
    "SQLite",
    "DBeaver"
