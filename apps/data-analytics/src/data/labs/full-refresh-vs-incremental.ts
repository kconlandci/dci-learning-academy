...
export const fullRefreshVsIncrementalLab: LabManifest = LabManifestSchema.parse({
  "schemaVersion": "1.1",
  "id": "full-refresh-vs-incremental",
  "version": 1,
  ...
  "description": "Practice full refresh vs incremental inside a realistic analytics workflow, choose the safest decision, and explain why it is the most trustworthy SQL or data move.",
  "estimatedMinutes": 14,
  "learningObjectives": [
    "Clarify the stakeholder need behind full refresh vs incremental.",
  ...
  "scenarios": [
    {
      ...
      "id": "full-refresh-vs-incremental-scenario-1",
      "title": "Investigate the surprising output",
      "objective": "A data ops lead flagged a surprising result while reviewing full refresh vs incremental. Inspect the evidence and decide the best next step before the metric is shared more widely.",
      "investigationData": [
        {
          "id": "source-query",
          "label": "Query Result Sample",
          "content": "Rows from staging.raw_orders show a 14% jump after a new join was added yesterday. Distinct entity count increased only 1%.",
          "isCritical": true
        },
        {
          "id": "source-note",
        ...
        },
        {
          ...
          "content": "The data ops lead needs a reliable explanation before presenting this number to leadership."
        }
      ],
      "actions": [
        {
    ...
    {
      "type": "investigate-decide",
      "id": "full-refresh-vs-incremental-scenario-2",
      "title": "Resolve the freshness conflict",
      "objective": "Two teams are quoting different outputs for full refresh vs incremental. Review the evidence and decide how to respond.",
      "investigationData": [
        {
          "id": "source-dashboard",
        ...
        },
        {
          "id": "source-chat",
          "label": "Team Chat",
          "content": "The data ops lead asks whether the 08:00 dashboard can still be used for today's review."
        }
      ],
      "actions": [
        {
    ...
    {
      "type": "investigate-decide",
      "id": "full-refresh-vs-incremental-scenario-3",
      "title": "Decide how to close the incident",
      "objective": "You have narrowed the issue behind full refresh vs incremental. Review the final evidence and choose the best closeout action.",
      "investigationData": [
        {
  ...
  "hints": [
    "Start by naming the business grain that full refresh vs incremental should produce.",
  ...
  "careerInsight": "Pipeline teams create trust at scale by spotting data quality risk before it turns into broken reporting or missed SLAs. Full Refresh vs Incremental is a common scenario in interviews, production reviews, and cross-functional planning.",
  "toolRelevance": [
    "dbt",
    "Airflow",
    "BigQuery"
