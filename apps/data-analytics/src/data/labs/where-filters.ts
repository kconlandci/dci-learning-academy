...
export const whereFiltersLab: LabManifest = LabManifestSchema.parse({
  "schemaVersion": "1.1",
  "id": "where-filters",
  "version": 1,
  "title": "Where Filters",
  ...
  "description": "Practice where filters inside a realistic analytics workflow, choose the safest decision, and explain why it is the most trustworthy SQL or data move.",
  "estimatedMinutes": 10,
  "learningObjectives": [
    "Clarify the stakeholder need behind where filters.",
  ...
  "scenarios": [
    {
      "type": "toggle-config",
      "id": "where-filters-scenario-1",
      "title": "Configure the default quality controls",
      "description": "You are preparing a shared asset for where filters. Set the defaults so the product manager gets trustworthy results without relying on tribal knowledge.",
      ...
      "feedback": {
        "perfect": "Great configuration. Where Filters becomes safer to reuse when quality checks, null policies, and reviews are explicit.",
    ...
    {
      "type": "toggle-config",
      "id": "where-filters-scenario-2",
      "title": "Set access and change controls",
      "description": "A wider audience wants self-service access to where filters. Configure the model so speed does not outrun governance.",
    ...
    {
      "type": "toggle-config",
      "id": "where-filters-scenario-3",
      "title": "Tune the publish workflow",
      "description": "The team wants a faster release cycle for where filters. Configure the publish workflow so the team can move quickly without normalizing broken output.",
  ...
  "hints": [
    "Start by naming the business grain that where filters should produce.",
  ...
  "careerInsight": "Reliable SQL fundamentals are the fastest way to become useful on analytics, reporting, and data engineering teams. Where Filters is a common scenario in interviews, production reviews, and cross-functional planning.",
  "toolRelevance": [
    "PostgreSQL",
    "SQLite",
    "DBeaver"
