...
export const marketingAttributionReportingLab: LabManifest = LabManifestSchema.parse({
  "schemaVersion": "1.1",
  "id": "marketing-attribution-reporting",
  "version": 1,
  ...
  "description": "Practice marketing attribution reporting inside a realistic analytics workflow, choose the safest decision, and explain why it is the most trustworthy SQL or data move.",
  "estimatedMinutes": 14,
  "learningObjectives": [
    "Clarify the stakeholder need behind marketing attribution reporting.",
  ...
  "prerequisites": [
    {
      "labId": "customer-support-dashboard",
      "minScore": 60
    }
  ],
  ...
  "scenarios": [
    {
      ...
      "id": "marketing-attribution-reporting-scenario-1",
      "title": "Investigate the surprising output",
      "objective": "A customer support lead flagged a surprising result while reviewing marketing attribution reporting. Inspect the evidence and decide the best next step before the metric is shared more widely.",
      "investigationData": [
        {
          "id": "source-query",
          "label": "Query Result Sample",
          "content": "Rows from bi.sales_pipeline show a 14% jump after a new join was added yesterday. Distinct entity count increased only 1%.",
          "isCritical": true
        },
        {
          "id": "source-note",
        ...
        },
        {
          ...
          "content": "The customer support lead needs a reliable explanation before presenting this number to leadership."
        }
      ],
      "actions": [
        {
    ...
    {
      "type": "investigate-decide",
      "id": "marketing-attribution-reporting-scenario-2",
      "title": "Resolve the freshness conflict",
      "objective": "Two teams are quoting different outputs for marketing attribution reporting. Review the evidence and decide how to respond.",
      "investigationData": [
        {
          "id": "source-dashboard",
        ...
        },
        {
          "id": "source-chat",
          "label": "Team Chat",
          "content": "The customer support lead asks whether the 08:00 dashboard can still be used for today's review."
        }
      ],
      "actions": [
        {
    ...
    {
      "type": "investigate-decide",
      "id": "marketing-attribution-reporting-scenario-3",
      "title": "Decide how to close the incident",
      "objective": "You have narrowed the issue behind marketing attribution reporting. Review the final evidence and choose the best closeout action.",
      "investigationData": [
        {
  ...
  "hints": [
    "Start by naming the business grain that marketing attribution reporting should produce.",
  ...
  "careerInsight": "Good BI work is not just chart building; it is metric definition, stakeholder alignment, and clear storytelling. Marketing Attribution Reporting is a common scenario in interviews, production reviews, and cross-functional planning.",
  "toolRelevance": [
    "Looker",
    "Power BI",
    "Tableau"
