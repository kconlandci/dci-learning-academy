...
export const unionSetOpsLab: LabManifest = LabManifestSchema.parse({
  "schemaVersion": "1.1",
  "id": "union-set-ops",
  "version": 1,
  ...
  "description": "Practice union and set operations inside a realistic analytics workflow, choose the safest decision, and explain why it is the most trustworthy SQL or data move.",
  "estimatedMinutes": 18,
  "learningObjectives": [
    "Clarify the stakeholder need behind union and set operations.",
  ...
  "scenarios": [
    {
      ...
      "id": "union-set-ops-scenario-1",
      "title": "Investigate the surprising output",
      "objective": "A operations manager flagged a surprising result while reviewing union and set operations. Inspect the evidence and decide the best next step before the metric is shared more widely.",
      "investigationData": [
        {
          "id": "source-query",
          "label": "Query Result Sample",
          "content": "Rows from warehouse.customers show a 14% jump after a new join was added yesterday. Distinct entity count increased only 1%.",
          "isCritical": true
        },
        {
          "id": "source-note",
        ...
        },
        {
          ...
          "content": "The operations manager needs a reliable explanation before presenting this number to leadership."
        }
      ],
      "actions": [
        {
    ...
    {
      "type": "investigate-decide",
      "id": "union-set-ops-scenario-2",
      "title": "Resolve the freshness conflict",
      "objective": "Two teams are quoting different outputs for union and set operations. Review the evidence and decide how to respond.",
      "investigationData": [
        {
          "id": "source-dashboard",
        ...
        },
        {
          "id": "source-chat",
          "label": "Team Chat",
          "content": "The operations manager asks whether the 08:00 dashboard can still be used for today's review."
        }
      ],
      "actions": [
        {
    ...
    {
      "type": "investigate-decide",
      "id": "union-set-ops-scenario-3",
      "title": "Decide how to close the incident",
      "objective": "You have narrowed the issue behind union and set operations. Review the final evidence and choose the best closeout action.",
      "investigationData": [
        {
  ...
  "hints": [
    "Start by naming the business grain that union and set operations should produce.",
  ...
  "careerInsight": "Reliable SQL fundamentals are the fastest way to become useful on analytics, reporting, and data engineering teams. Union and Set Operations is a common scenario in interviews, production reviews, and cross-functional planning.",
  "toolRelevance": [
    "PostgreSQL",
    "SQLite",
    "DBeaver"
