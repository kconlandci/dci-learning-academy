...
export const pivotCrossTabLab: LabManifest = LabManifestSchema.parse({
  "schemaVersion": "1.1",
  "id": "pivot-cross-tab",
  "version": 1,
  ...
  "description": "Practice pivot cross tab inside a realistic analytics workflow, choose the safest decision, and explain why it is the most trustworthy SQL or data move.",
  "estimatedMinutes": 14,
  "learningObjectives": [
    "Clarify the stakeholder need behind pivot cross tab.",
  ...
  "scenarios": [
    {
      "type": "toggle-config",
      "id": "pivot-cross-tab-scenario-1",
      "title": "Configure the default quality controls",
      "description": "You are preparing a shared asset for pivot cross tab. Set the defaults so the growth analyst gets trustworthy results without relying on tribal knowledge.",
      "targetSystem": "mart.customer_cohorts.semantic_model",
      "items": [
        {
          "id": "grain-check",
      ...
      "feedback": {
        "perfect": "Great configuration. Pivot Cross Tab becomes safer to reuse when quality checks, null policies, and reviews are explicit.",
    ...
    {
      "type": "toggle-config",
      "id": "pivot-cross-tab-scenario-2",
      "title": "Set access and change controls",
      "description": "A wider audience wants self-service access to pivot cross tab. Configure the model so speed does not outrun governance.",
      "targetSystem": "mart.customer_cohorts.reporting_view",
      "items": [
        {
          "id": "access-scope",
          "label": "Access Scope",
    ...
    {
      "type": "toggle-config",
      "id": "pivot-cross-tab-scenario-3",
      "title": "Tune the publish workflow",
      "description": "The team wants a faster release cycle for pivot cross tab. Configure the publish workflow so the team can move quickly without normalizing broken output.",
      "targetSystem": "mart.customer_cohorts.publish_job",
      "items": [
        {
          "id": "test-suite",
  ...
  "hints": [
    "Start by naming the business grain that pivot cross tab should produce.",
  ...
  "careerInsight": "Analysts who can explain trends with clean SQL and defensible logic become the people leaders trust in decision meetings. Pivot Cross Tab is a common scenario in interviews, production reviews, and cross-functional planning.",
  "toolRelevance": [
    "DuckDB",
    "BigQuery",
    "Looker Studio"
