...
export const joinOrderTuningLab: LabManifest = LabManifestSchema.parse({
  "schemaVersion": "1.1",
  "id": "join-order-tuning",
  "version": 1,
  "title": "Join Order Tuning",
  "tier": "beginner",
  ...
  "description": "Practice join order tuning inside a realistic analytics workflow, choose the safest decision, and explain why it is the most trustworthy SQL or data move.",
  "estimatedMinutes": 10,
  "learningObjectives": [
    "Clarify the stakeholder need behind join order tuning.",
  ...
  "scenarios": [
    {
      ...
      "id": "join-order-tuning-scenario-1",
      "title": "Investigate the surprising output",
      "objective": "A analytics engineering manager flagged a surprising result while reviewing join order tuning. Inspect the evidence and decide the best next step before the metric is shared more widely.",
      "investigationData": [
        {
          "id": "source-query",
    ...
    {
      "type": "investigate-decide",
      "id": "join-order-tuning-scenario-2",
      "title": "Resolve the freshness conflict",
      "objective": "Two teams are quoting different outputs for join order tuning. Review the evidence and decide how to respond.",
      "investigationData": [
        {
          "id": "source-dashboard",
    ...
    {
      "type": "investigate-decide",
      "id": "join-order-tuning-scenario-3",
      "title": "Decide how to close the incident",
      "objective": "You have narrowed the issue behind join order tuning. Review the final evidence and choose the best closeout action.",
      "investigationData": [
        {
  ...
  "hints": [
    "Start by naming the business grain that join order tuning should produce.",
  ...
  "careerInsight": "Advanced analytics work often separates solid SQL users from the engineers who can keep an entire warehouse fast and stable. Join Order Tuning is a common scenario in interviews, production reviews, and cross-functional planning.",
  "toolRelevance": [
    "EXPLAIN plans",
    "Snowflake",
    "PostgreSQL"
