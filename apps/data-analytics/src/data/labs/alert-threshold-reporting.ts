...
export const alertThresholdReportingLab: LabManifest = LabManifestSchema.parse({
  "schemaVersion": "1.1",
  "id": "alert-threshold-reporting",
  "version": 1,
  "title": "Alert Threshold Reporting",
  "tier": "advanced",
  ...
  "description": "Practice alert threshold reporting inside a realistic analytics workflow, choose the safest decision, and explain why it is the most trustworthy SQL or data move.",
  "estimatedMinutes": 18,
  "learningObjectives": [
    "Clarify the stakeholder need behind alert threshold reporting.",
  ...
  "scenarios": [
    {
      ...
      "id": "alert-threshold-reporting-scenario-1",
      "title": "Triage the broken result",
      "description": "A delivery team escalated alert threshold reporting after seeing an unexpected spike. Classify the issue, pick the right remediation, and explain your decision.",
      "evidence": [
        {
          "type": "query output",
          "content": "The bi.executive_scorecard result set doubled after a new dimension join was released."
        },
        {
          "type": "quality alert",
        ...
        },
        {
          ...
          "content": "The customer support lead needs a trusted answer before tomorrow's review."
        }
      ],
      "classifications": [
        {
    ...
    {
      "type": "triage-remediate",
      "id": "alert-threshold-reporting-scenario-2",
      "title": "Classify the stale dashboard",
      "description": "A shared dashboard built on alert threshold reporting is stale after a failed refresh. Decide how to classify and remediate the issue.",
      "evidence": [
        {
          "type": "refresh log",
    ...
    {
      "type": "triage-remediate",
      "id": "alert-threshold-reporting-scenario-3",
      "title": "Close the definition mismatch",
      "description": "A metric built for alert threshold reporting changed meaning after a silent definition update. Classify the issue and choose the best remediation.",
      "evidence": [
        {
          "type": "change note",
        ...
        {
          "type": "owner feedback",
          "content": "The customer support lead wants a correction, a root-cause note, and a safer handoff next time."
        }
      ],
      "classifications": [
        {
  ...
  "hints": [
    "Start by naming the business grain that alert threshold reporting should produce.",
  ...
  "careerInsight": "Good BI work is not just chart building; it is metric definition, stakeholder alignment, and clear storytelling. Alert Threshold Reporting is a common scenario in interviews, production reviews, and cross-functional planning.",
  "toolRelevance": [
    "Looker",
    "Power BI",
    "Tableau"
