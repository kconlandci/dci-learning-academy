...
export const denormalizationTradeoffsLab: LabManifest = LabManifestSchema.parse({
  "schemaVersion": "1.1",
  ...
  "description": "Practice denormalization tradeoffs inside a realistic analytics workflow, choose the safest decision, and explain why it is the most trustworthy SQL or data move.",
  "estimatedMinutes": 14,
  "learningObjectives": [
    "Clarify the stakeholder need behind denormalization tradeoffs.",
  ...
  "scenarios": [
    {
      ...
      "id": "denormalization-tradeoffs-scenario-1",
      "title": "Investigate the surprising output",
      "objective": "A platform engineer flagged a surprising result while reviewing denormalization tradeoffs. Inspect the evidence and decide the best next step before the metric is shared more widely.",
      "investigationData": [
        {
          "id": "source-query",
          "label": "Query Result Sample",
          "content": "Rows from core.order_facts show a 14% jump after a new join was added yesterday. Distinct entity count increased only 1%.",
          "isCritical": true
        },
        {
          "id": "source-note",
        ...
        },
        {
          ...
          "content": "The platform engineer needs a reliable explanation before presenting this number to leadership."
        }
      ],
      "actions": [
        {
    ...
    {
      "type": "investigate-decide",
      "id": "denormalization-tradeoffs-scenario-2",
      "title": "Resolve the freshness conflict",
      "objective": "Two teams are quoting different outputs for denormalization tradeoffs. Review the evidence and decide how to respond.",
      "investigationData": [
        {
          "id": "source-dashboard",
        ...
        },
        {
          "id": "source-chat",
          "label": "Team Chat",
          "content": "The platform engineer asks whether the 08:00 dashboard can still be used for today's review."
        }
      ],
      "actions": [
        {
    ...
    {
      "type": "investigate-decide",
      "id": "denormalization-tradeoffs-scenario-3",
      "title": "Decide how to close the incident",
      "objective": "You have narrowed the issue behind denormalization tradeoffs. Review the final evidence and choose the best closeout action.",
      "investigationData": [
        {
  ...
  "hints": [
    "Start by naming the business grain that denormalization tradeoffs should produce.",
  ...
  "careerInsight": "Strong data modeling judgment helps teams avoid duplicated logic, brittle pipelines, and expensive rework. Denormalization Tradeoffs is a common scenario in interviews, production reviews, and cross-functional planning.",
  "toolRelevance": [
    "dbdiagram.io",
    "PostgreSQL",
    "Flyway"
