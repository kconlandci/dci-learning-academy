...
export const stringCleanupLab: LabManifest = LabManifestSchema.parse({
  "schemaVersion": "1.1",
  "id": "string-cleanup",
  "version": 1,
  ...
  "description": "Practice string cleanup inside a realistic analytics workflow, choose the safest decision, and explain why it is the most trustworthy SQL or data move.",
  "estimatedMinutes": 14,
  "learningObjectives": [
    "Clarify the stakeholder need behind string cleanup.",
  ...
  "scenarios": [
    {
      "type": "toggle-config",
      "id": "string-cleanup-scenario-1",
      "title": "Configure the default quality controls",
      "description": "You are preparing a shared asset for string cleanup. Set the defaults so the product manager gets trustworthy results without relying on tribal knowledge.",
      "targetSystem": "warehouse.products.semantic_model",
      "items": [
        {
          "id": "grain-check",
      ...
      "feedback": {
        "perfect": "Great configuration. String Cleanup becomes safer to reuse when quality checks, null policies, and reviews are explicit.",
    ...
    {
      "type": "toggle-config",
      "id": "string-cleanup-scenario-2",
      "title": "Set access and change controls",
      "description": "A wider audience wants self-service access to string cleanup. Configure the model so speed does not outrun governance.",
      "targetSystem": "warehouse.products.reporting_view",
      "items": [
        {
          "id": "access-scope",
          "label": "Access Scope",
    ...
    {
      "type": "toggle-config",
      "id": "string-cleanup-scenario-3",
      "title": "Tune the publish workflow",
      "description": "The team wants a faster release cycle for string cleanup. Configure the publish workflow so the team can move quickly without normalizing broken output.",
      "targetSystem": "warehouse.products.publish_job",
      "items": [
        {
          "id": "test-suite",
  ...
  "hints": [
    "Start by naming the business grain that string cleanup should produce.",
  ...
  "careerInsight": "Reliable SQL fundamentals are the fastest way to become useful on analytics, reporting, and data engineering teams. String Cleanup is a common scenario in interviews, production reviews, and cross-functional planning.",
  "toolRelevance": [
    "PostgreSQL",
    "SQLite",
    "DBeaver"
