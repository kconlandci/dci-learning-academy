...
export const auditColumnsLab: LabManifest = LabManifestSchema.parse({
  "schemaVersion": "1.1",
  "id": "audit-columns",
  "version": 1,
  "title": "Audit Columns",
  ...
  "description": "Practice audit columns inside a realistic analytics workflow, choose the safest decision, and explain why it is the most trustworthy SQL or data move.",
  "estimatedMinutes": 14,
  "learningObjectives": [
    "Clarify the stakeholder need behind audit columns.",
  ...
  "prerequisites": [
    {
      "labId": "denormalization-tradeoffs",
      "minScore": 60
    }
  ],
  ...
  "scenarios": [
    {
      ...
      "id": "audit-columns-scenario-1",
      "title": "Triage the broken result",
      "description": "A delivery team escalated audit columns after seeing an unexpected spike. Classify the issue, pick the right remediation, and explain your decision.",
      "evidence": [
        {
          "type": "query output",
          "content": "The core.subscription_events result set doubled after a new dimension join was released."
        },
        {
          "type": "quality alert",
        ...
        },
        {
          ...
          "content": "The backend lead needs a trusted answer before tomorrow's review."
        }
      ],
      "classifications": [
        {
    ...
    {
      "type": "triage-remediate",
      "id": "audit-columns-scenario-2",
      "title": "Classify the stale dashboard",
      "description": "A shared dashboard built on audit columns is stale after a failed refresh. Decide how to classify and remediate the issue.",
      "evidence": [
        {
          "type": "refresh log",
    ...
    {
      "type": "triage-remediate",
      "id": "audit-columns-scenario-3",
      "title": "Close the definition mismatch",
      "description": "A metric built for audit columns changed meaning after a silent definition update. Classify the issue and choose the best remediation.",
      "evidence": [
        {
          "type": "change note",
        ...
        {
          "type": "owner feedback",
          "content": "The backend lead wants a correction, a root-cause note, and a safer handoff next time."
        }
      ],
      "classifications": [
        {
  ...
  "hints": [
    "Start by naming the business grain that audit columns should produce.",
  ...
  "careerInsight": "Strong data modeling judgment helps teams avoid duplicated logic, brittle pipelines, and expensive rework. Audit Columns is a common scenario in interviews, production reviews, and cross-functional planning.",
  "toolRelevance": [
    "dbdiagram.io",
    "PostgreSQL",
    "Flyway"
