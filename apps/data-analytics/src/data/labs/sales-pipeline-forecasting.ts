...
export const salesPipelineForecastingLab: LabManifest = LabManifestSchema.parse({
  "schemaVersion": "1.1",
  ...
  "description": "Practice sales pipeline forecasting inside a realistic analytics workflow, choose the safest decision, and explain why it is the most trustworthy SQL or data move.",
  "estimatedMinutes": 14,
  "learningObjectives": [
    "Clarify the stakeholder need behind sales pipeline forecasting.",
  ...
  "prerequisites": [
    {
      "labId": "fiscal-calendar-reporting",
      "minScore": 60
    }
  ],
  ...
  "scenarios": [
    {
      ...
      "id": "sales-pipeline-forecasting-scenario-1",
      "title": "Choose the strongest SQL approach",
      "context": "BI manager needs a reliable answer for sales pipeline forecasting before the weekly review. Pick the action that keeps the query auditable and the result grain stable under deadline pressure.",
      "displayFields": [
        {
          "label": "Dataset",
          "value": "bi.support_metrics"
        },
        {
          "label": "Deadline",
          "value": "30 minutes",
      ...
      "feedback": {
        "perfect": "Excellent. Sales Pipeline Forecasting is strongest when you keep the grain explicit and validate the joins before sharing a metric.",
        ...
        "wrong": "That choice adds avoidable risk. For sales pipeline forecasting, the best move is the option that stays reviewable and grain-aware."
      }
    },
    {
      "type": "action-rationale",
      "id": "sales-pipeline-forecasting-scenario-2",
      "title": "Handle the stakeholder follow-up",
      "context": "After your first draft, the BI manager asks for one more slice of sales pipeline forecasting by region. Decide how to respond without turning a clean query into a fragile one-off.",
      "displayFields": [
        {
          "label": "Current asset",
          "value": "sales-pipeline-forecasting_draft.sql"
        },
        {
    ...
    {
      "type": "action-rationale",
      "id": "sales-pipeline-forecasting-scenario-3",
      "title": "Explain why the result is trustworthy",
      "context": "You are presenting sales pipeline forecasting in a team review. Choose the explanation that best demonstrates sound analytics judgment.",
      "displayFields": [
        {
          "label": "Audience",
  ...
  "hints": [
    "Start by naming the business grain that sales pipeline forecasting should produce.",
  ...
  "careerInsight": "Good BI work is not just chart building; it is metric definition, stakeholder alignment, and clear storytelling. Sales Pipeline Forecasting is a common scenario in interviews, production reviews, and cross-functional planning.",
  "toolRelevance": [
    "Looker",
    "Power BI",
    "Tableau"
