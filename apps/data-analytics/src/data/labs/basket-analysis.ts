...
export const basketAnalysisLab: LabManifest = LabManifestSchema.parse({
  "schemaVersion": "1.1",
  "id": "basket-analysis",
  "version": 1,
  ...
  "description": "Practice basket analysis inside a realistic analytics workflow, choose the safest decision, and explain why it is the most trustworthy SQL or data move.",
  "estimatedMinutes": 14,
  "learningObjectives": [
    "Clarify the stakeholder need behind basket analysis.",
  ...
  "scenarios": [
    {
      ...
      "id": "basket-analysis-scenario-1",
      "title": "Triage the broken result",
      "description": "A delivery team escalated basket analysis after seeing an unexpected spike. Classify the issue, pick the right remediation, and explain your decision.",
      "evidence": [
        {
          "type": "query output",
          "content": "The mart.session_events result set doubled after a new dimension join was released."
        },
        {
          "type": "quality alert",
        ...
        },
        {
          ...
          "content": "The finance partner needs a trusted answer before tomorrow's review."
        }
      ],
      "classifications": [
        {
    ...
    {
      "type": "triage-remediate",
      "id": "basket-analysis-scenario-2",
      "title": "Classify the stale dashboard",
      "description": "A shared dashboard built on basket analysis is stale after a failed refresh. Decide how to classify and remediate the issue.",
      "evidence": [
        {
          "type": "refresh log",
    ...
    {
      "type": "triage-remediate",
      "id": "basket-analysis-scenario-3",
      "title": "Close the definition mismatch",
      "description": "A metric built for basket analysis changed meaning after a silent definition update. Classify the issue and choose the best remediation.",
      "evidence": [
        {
          "type": "change note",
        ...
        {
          "type": "owner feedback",
          "content": "The finance partner wants a correction, a root-cause note, and a safer handoff next time."
        }
      ],
      "classifications": [
        {
  ...
  "hints": [
    "Start by naming the business grain that basket analysis should produce.",
  ...
  "careerInsight": "Analysts who can explain trends with clean SQL and defensible logic become the people leaders trust in decision meetings. Basket Analysis is a common scenario in interviews, production reviews, and cross-functional planning.",
  "toolRelevance": [
    "DuckDB",
    "BigQuery",
    "Looker Studio"
