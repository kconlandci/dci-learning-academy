...
export const customerSupportDashboardLab: LabManifest = LabManifestSchema.parse({
  "schemaVersion": "1.1",
  ...
  "description": "Practice customer support dashboard inside a realistic analytics workflow, choose the safest decision, and explain why it is the most trustworthy SQL or data move.",
  "estimatedMinutes": 14,
  "learningObjectives": [
    "Clarify the stakeholder need behind customer support dashboard.",
  ...
  "prerequisites": [
    {
      "labId": "sales-pipeline-forecasting",
      "minScore": 60
    }
  ],
  ...
  "scenarios": [
    {
      "type": "toggle-config",
      "id": "customer-support-dashboard-scenario-1",
      "title": "Configure the default quality controls",
      "description": "You are preparing a shared asset for customer support dashboard. Set the defaults so the customer support lead gets trustworthy results without relying on tribal knowledge.",
      "targetSystem": "bi.executive_scorecard.semantic_model",
      "items": [
        {
          "id": "grain-check",
      ...
      "feedback": {
        "perfect": "Great configuration. Customer Support Dashboard becomes safer to reuse when quality checks, null policies, and reviews are explicit.",
    ...
    {
      "type": "toggle-config",
      "id": "customer-support-dashboard-scenario-2",
      "title": "Set access and change controls",
      "description": "A wider audience wants self-service access to customer support dashboard. Configure the model so speed does not outrun governance.",
      "targetSystem": "bi.executive_scorecard.reporting_view",
      "items": [
        {
          "id": "access-scope",
          "label": "Access Scope",
    ...
    {
      "type": "toggle-config",
      "id": "customer-support-dashboard-scenario-3",
      "title": "Tune the publish workflow",
      "description": "The team wants a faster release cycle for customer support dashboard. Configure the publish workflow so the team can move quickly without normalizing broken output.",
      "targetSystem": "bi.executive_scorecard.publish_job",
      "items": [
        {
          "id": "test-suite",
  ...
  "hints": [
    "Start by naming the business grain that customer support dashboard should produce.",
  ...
  "careerInsight": "Good BI work is not just chart building; it is metric definition, stakeholder alignment, and clear storytelling. Customer Support Dashboard is a common scenario in interviews, production reviews, and cross-functional planning.",
  "toolRelevance": [
    "Looker",
    "Power BI",
    "Tableau"
