...
export const cacheInvalidationAnalyticsLab: LabManifest = LabManifestSchema.parse({
  "schemaVersion": "1.1",
  "id": "cache-invalidation-analytics",
  "version": 1,
  "title": "Cache Invalidation Analytics",
  "tier": "advanced",
  ...
  "description": "Practice cache invalidation analytics inside a realistic analytics workflow, choose the safest decision, and explain why it is the most trustworthy SQL or data move.",
  "estimatedMinutes": 18,
  "learningObjectives": [
    "Clarify the stakeholder need behind cache invalidation analytics.",
  ...
  "prerequisites": [
    {
      "labId": "warehouse-scaling-decisions",
      "minScore": 60
    }
  ],
  ...
  "scenarios": [
    {
      ...
      "id": "cache-invalidation-analytics-scenario-1",
      "title": "Triage the broken result",
      "description": "A delivery team escalated cache invalidation analytics after seeing an unexpected spike. Classify the issue, pick the right remediation, and explain your decision.",
      "evidence": [
        {
          "type": "query output",
          "content": "The warehouse.compute_usage result set doubled after a new dimension join was released."
        },
        {
          "type": "quality alert",
        ...
        },
        {
          ...
          "content": "The warehouse engineer needs a trusted answer before tomorrow's review."
        }
      ],
      "classifications": [
        {
    ...
    {
      "type": "triage-remediate",
      "id": "cache-invalidation-analytics-scenario-2",
      "title": "Classify the stale dashboard",
      "description": "A shared dashboard built on cache invalidation analytics is stale after a failed refresh. Decide how to classify and remediate the issue.",
      "evidence": [
        {
          "type": "refresh log",
    ...
    {
      "type": "triage-remediate",
      "id": "cache-invalidation-analytics-scenario-3",
      "title": "Close the definition mismatch",
      "description": "A metric built for cache invalidation analytics changed meaning after a silent definition update. Classify the issue and choose the best remediation.",
      "evidence": [
        {
          "type": "change note",
        ...
        {
          "type": "owner feedback",
          "content": "The warehouse engineer wants a correction, a root-cause note, and a safer handoff next time."
        }
      ],
      "classifications": [
        {
  ...
  "hints": [
    "Start by naming the business grain that cache invalidation analytics should produce.",
  ...
  "careerInsight": "Advanced analytics work often separates solid SQL users from the engineers who can keep an entire warehouse fast and stable. Cache Invalidation Analytics is a common scenario in interviews, production reviews, and cross-functional planning.",
  "toolRelevance": [
    "EXPLAIN plans",
    "Snowflake",
    "PostgreSQL"
