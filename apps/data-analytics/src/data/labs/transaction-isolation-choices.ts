...
export const transactionIsolationChoicesLab: LabManifest = LabManifestSchema.parse({
  "schemaVersion": "1.1",
  "id": "transaction-isolation-choices",
  "version": 1,
  "title": "Transaction Isolation Choices",
  "tier": "intermediate",
  ...
  "description": "Practice transaction isolation choices inside a realistic analytics workflow, choose the safest decision, and explain why it is the most trustworthy SQL or data move.",
  "estimatedMinutes": 14,
  "learningObjectives": [
    "Clarify the stakeholder need behind transaction isolation choices.",
  ...
  "scenarios": [
    {
      ...
      "id": "transaction-isolation-choices-scenario-1",
      "title": "Triage the broken result",
      "description": "A delivery team escalated transaction isolation choices after seeing an unexpected spike. Classify the issue, pick the right remediation, and explain your decision.",
      "evidence": [
        {
          "type": "query output",
          "content": "The warehouse.fact_sessions result set doubled after a new dimension join was released."
        },
        {
          "type": "quality alert",
        ...
        },
        {
          ...
          "content": "The analytics engineering manager needs a trusted answer before tomorrow's review."
        }
      ],
      "classifications": [
        {
    ...
    {
      "type": "triage-remediate",
      "id": "transaction-isolation-choices-scenario-2",
      "title": "Classify the stale dashboard",
      "description": "A shared dashboard built on transaction isolation choices is stale after a failed refresh. Decide how to classify and remediate the issue.",
      "evidence": [
        {
          "type": "refresh log",
    ...
    {
      "type": "triage-remediate",
      "id": "transaction-isolation-choices-scenario-3",
      "title": "Close the definition mismatch",
      "description": "A metric built for transaction isolation choices changed meaning after a silent definition update. Classify the issue and choose the best remediation.",
      "evidence": [
        {
          "type": "change note",
        ...
        {
          "type": "owner feedback",
          "content": "The analytics engineering manager wants a correction, a root-cause note, and a safer handoff next time."
        }
      ],
      "classifications": [
        {
  ...
  "hints": [
    "Start by naming the business grain that transaction isolation choices should produce.",
  ...
  "careerInsight": "Advanced analytics work often separates solid SQL users from the engineers who can keep an entire warehouse fast and stable. Transaction Isolation Choices is a common scenario in interviews, production reviews, and cross-functional planning.",
  "toolRelevance": [
    "EXPLAIN plans",
    "Snowflake",
    "PostgreSQL"
