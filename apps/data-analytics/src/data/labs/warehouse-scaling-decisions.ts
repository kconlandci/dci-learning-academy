...
export const warehouseScalingDecisionsLab: LabManifest = LabManifestSchema.parse({
  "schemaVersion": "1.1",
  "id": "warehouse-scaling-decisions",
  "version": 1,
  "title": "Warehouse Scaling Decisions",
  "tier": "advanced",
  ...
  "description": "Practice warehouse scaling decisions inside a realistic analytics workflow, choose the safest decision, and explain why it is the most trustworthy SQL or data move.",
  "estimatedMinutes": 18,
  "learningObjectives": [
    "Clarify the stakeholder need behind warehouse scaling decisions.",
  ...
  "prerequisites": [
    {
      "labId": "parameter-sniffing-analysis",
      "minScore": 60
    }
  ],
  ...
  "scenarios": [
    {
      ...
      "id": "warehouse-scaling-decisions-scenario-1",
      "title": "Investigate the surprising output",
      "objective": "A analytics engineering manager flagged a surprising result while reviewing warehouse scaling decisions. Inspect the evidence and decide the best next step before the metric is shared more widely.",
      "investigationData": [
        {
          "id": "source-query",
          "label": "Query Result Sample",
          "content": "Rows from warehouse.query_history show a 14% jump after a new join was added yesterday. Distinct entity count increased only 1%.",
          "isCritical": true
        },
        {
          "id": "source-note",
        ...
        },
        {
          ...
          "content": "The analytics engineering manager needs a reliable explanation before presenting this number to leadership."
        }
      ],
      "actions": [
        {
    ...
    {
      "type": "investigate-decide",
      "id": "warehouse-scaling-decisions-scenario-2",
      "title": "Resolve the freshness conflict",
      "objective": "Two teams are quoting different outputs for warehouse scaling decisions. Review the evidence and decide how to respond.",
      "investigationData": [
        {
          "id": "source-dashboard",
        ...
        },
        {
          "id": "source-chat",
          "label": "Team Chat",
          "content": "The analytics engineering manager asks whether the 08:00 dashboard can still be used for today's review."
        }
      ],
      "actions": [
        {
    ...
    {
      "type": "investigate-decide",
      "id": "warehouse-scaling-decisions-scenario-3",
      "title": "Decide how to close the incident",
      "objective": "You have narrowed the issue behind warehouse scaling decisions. Review the final evidence and choose the best closeout action.",
      "investigationData": [
        {
  ...
  "hints": [
    "Start by naming the business grain that warehouse scaling decisions should produce.",
  ...
  "careerInsight": "Advanced analytics work often separates solid SQL users from the engineers who can keep an entire warehouse fast and stable. Warehouse Scaling Decisions is a common scenario in interviews, production reviews, and cross-functional planning.",
  "toolRelevance": [
    "EXPLAIN plans",
    "Snowflake",
    "PostgreSQL"
