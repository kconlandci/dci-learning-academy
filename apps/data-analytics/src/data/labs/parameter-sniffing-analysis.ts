...
export const parameterSniffingAnalysisLab: LabManifest = LabManifestSchema.parse({
  "schemaVersion": "1.1",
  "id": "parameter-sniffing-analysis",
  "version": 1,
  "title": "Parameter Sniffing Analysis",
  "tier": "advanced",
  ...
  "description": "Practice parameter sniffing analysis inside a realistic analytics workflow, choose the safest decision, and explain why it is the most trustworthy SQL or data move.",
  "estimatedMinutes": 18,
  "learningObjectives": [
    "Clarify the stakeholder need behind parameter sniffing analysis.",
  ...
  "prerequisites": [
    {
      "labId": "index-maintenance-automation",
      "minScore": 60
    }
  ],
  ...
  "scenarios": [
    {
      "type": "toggle-config",
      "id": "parameter-sniffing-analysis-scenario-1",
      "title": "Configure the default quality controls",
      "description": "You are preparing a shared asset for parameter sniffing analysis. Set the defaults so the analytics engineering manager gets trustworthy results without relying on tribal knowledge.",
      "targetSystem": "warehouse.fact_sessions.semantic_model",
      "items": [
        {
          "id": "grain-check",
      ...
      "feedback": {
        "perfect": "Great configuration. Parameter Sniffing Analysis becomes safer to reuse when quality checks, null policies, and reviews are explicit.",
    ...
    {
      "type": "toggle-config",
      "id": "parameter-sniffing-analysis-scenario-2",
      "title": "Set access and change controls",
      "description": "A wider audience wants self-service access to parameter sniffing analysis. Configure the model so speed does not outrun governance.",
      "targetSystem": "warehouse.fact_sessions.reporting_view",
      "items": [
        {
          "id": "access-scope",
          "label": "Access Scope",
    ...
    {
      "type": "toggle-config",
      "id": "parameter-sniffing-analysis-scenario-3",
      "title": "Tune the publish workflow",
      "description": "The team wants a faster release cycle for parameter sniffing analysis. Configure the publish workflow so the team can move quickly without normalizing broken output.",
      "targetSystem": "warehouse.fact_sessions.publish_job",
      "items": [
        {
          "id": "test-suite",
  ...
  "hints": [
    "Start by naming the business grain that parameter sniffing analysis should produce.",
  ...
  "careerInsight": "Advanced analytics work often separates solid SQL users from the engineers who can keep an entire warehouse fast and stable. Parameter Sniffing Analysis is a common scenario in interviews, production reviews, and cross-functional planning.",
  "toolRelevance": [
    "EXPLAIN plans",
    "Snowflake",
    "PostgreSQL"
