...
export const dataQualityThresholdsLab: LabManifest = LabManifestSchema.parse({
  "schemaVersion": "1.1",
  "id": "data-quality-thresholds",
  "version": 1,
  ...
  "description": "Practice data quality thresholds inside a realistic analytics workflow, choose the safest decision, and explain why it is the most trustworthy SQL or data move.",
  "estimatedMinutes": 14,
  "learningObjectives": [
    "Clarify the stakeholder need behind data quality thresholds.",
  ...
  "prerequisites": [
    {
      "labId": "surrogate-key-generation",
      "minScore": 60
    }
  ],
  ...
  "scenarios": [
    {
      ...
      "id": "data-quality-thresholds-scenario-1",
      "title": "Choose the strongest SQL approach",
      "context": "analytics engineer needs a reliable answer for data quality thresholds before the weekly review. Pick the action that keeps the query auditable and the result grain stable under deadline pressure.",
      "displayFields": [
        {
          "label": "Dataset",
          "value": "orchestration.pipeline_runs"
        },
        {
          "label": "Deadline",
          "value": "30 minutes",
      ...
      "feedback": {
        "perfect": "Excellent. Data Quality Thresholds is strongest when you keep the grain explicit and validate the joins before sharing a metric.",
        ...
        "wrong": "That choice adds avoidable risk. For data quality thresholds, the best move is the option that stays reviewable and grain-aware."
      }
    },
    {
      "type": "action-rationale",
      "id": "data-quality-thresholds-scenario-2",
      "title": "Handle the stakeholder follow-up",
      "context": "After your first draft, the analytics engineer asks for one more slice of data quality thresholds by region. Decide how to respond without turning a clean query into a fragile one-off.",
      "displayFields": [
        {
          "label": "Current asset",
          "value": "data-quality-thresholds_draft.sql"
        },
        {
    ...
    {
      "type": "action-rationale",
      "id": "data-quality-thresholds-scenario-3",
      "title": "Explain why the result is trustworthy",
      "context": "You are presenting data quality thresholds in a team review. Choose the explanation that best demonstrates sound analytics judgment.",
      "displayFields": [
        {
          "label": "Audience",
  ...
  "hints": [
    "Start by naming the business grain that data quality thresholds should produce.",
  ...
  "careerInsight": "Pipeline teams create trust at scale by spotting data quality risk before it turns into broken reporting or missed SLAs. Data Quality Thresholds is a common scenario in interviews, production reviews, and cross-functional planning.",
  "toolRelevance": [
    "dbt",
    "Airflow",
    "BigQuery"
