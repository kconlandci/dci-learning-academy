...
export const pipelineSlaMonitoringLab: LabManifest = LabManifestSchema.parse({
  "schemaVersion": "1.1",
  "id": "pipeline-sla-monitoring",
  "version": 1,
  ...
  "description": "Practice pipeline sla monitoring inside a realistic analytics workflow, choose the safest decision, and explain why it is the most trustworthy SQL or data move.",
  "estimatedMinutes": 18,
  "learningObjectives": [
    "Clarify the stakeholder need behind pipeline sla monitoring.",
  ...
  "scenarios": [
    {
      ...
      "id": "pipeline-sla-monitoring-scenario-1",
      "title": "Choose the strongest SQL approach",
      "context": "data ops lead needs a reliable answer for pipeline sla monitoring before the weekly review. Pick the action that keeps the query auditable and the result grain stable under deadline pressure.",
      "displayFields": [
        {
          "label": "Dataset",
          "value": "staging.raw_orders"
        },
        {
          "label": "Deadline",
          "value": "30 minutes",
      ...
      "feedback": {
        "perfect": "Excellent. Pipeline SLA Monitoring is strongest when you keep the grain explicit and validate the joins before sharing a metric.",
        ...
        "wrong": "That choice adds avoidable risk. For pipeline sla monitoring, the best move is the option that stays reviewable and grain-aware."
      }
    },
    {
      "type": "action-rationale",
      "id": "pipeline-sla-monitoring-scenario-2",
      "title": "Handle the stakeholder follow-up",
      "context": "After your first draft, the data ops lead asks for one more slice of pipeline sla monitoring by region. Decide how to respond without turning a clean query into a fragile one-off.",
      "displayFields": [
        {
          "label": "Current asset",
          "value": "pipeline-sla-monitoring_draft.sql"
        },
        {
    ...
    {
      "type": "action-rationale",
      "id": "pipeline-sla-monitoring-scenario-3",
      "title": "Explain why the result is trustworthy",
      "context": "You are presenting pipeline sla monitoring in a team review. Choose the explanation that best demonstrates sound analytics judgment.",
      "displayFields": [
        {
          "label": "Audience",
  ...
  "hints": [
    "Start by naming the business grain that pipeline sla monitoring should produce.",
  ...
  "careerInsight": "Pipeline teams create trust at scale by spotting data quality risk before it turns into broken reporting or missed SLAs. Pipeline SLA Monitoring is a common scenario in interviews, production reviews, and cross-functional planning.",
  "toolRelevance": [
    "dbt",
    "Airflow",
    "BigQuery"
