...
export const transformationLineageLab: LabManifest = LabManifestSchema.parse({
  "schemaVersion": "1.1",
  "id": "transformation-lineage",
  "version": 1,
  ...
  "description": "Practice transformation lineage inside a realistic analytics workflow, choose the safest decision, and explain why it is the most trustworthy SQL or data move.",
  "estimatedMinutes": 18,
  "learningObjectives": [
    "Clarify the stakeholder need behind transformation lineage.",
  ...
  "scenarios": [
    {
      "type": "toggle-config",
      "id": "transformation-lineage-scenario-1",
      "title": "Configure the default quality controls",
      "description": "You are preparing a shared asset for transformation lineage. Set the defaults so the analytics engineer gets trustworthy results without relying on tribal knowledge.",
      "targetSystem": "staging.raw_customers.semantic_model",
      "items": [
        {
          "id": "grain-check",
      ...
      "feedback": {
        "perfect": "Great configuration. Transformation Lineage becomes safer to reuse when quality checks, null policies, and reviews are explicit.",
    ...
    {
      "type": "toggle-config",
      "id": "transformation-lineage-scenario-2",
      "title": "Set access and change controls",
      "description": "A wider audience wants self-service access to transformation lineage. Configure the model so speed does not outrun governance.",
      "targetSystem": "staging.raw_customers.reporting_view",
      "items": [
        {
          "id": "access-scope",
          "label": "Access Scope",
    ...
    {
      "type": "toggle-config",
      "id": "transformation-lineage-scenario-3",
      "title": "Tune the publish workflow",
      "description": "The team wants a faster release cycle for transformation lineage. Configure the publish workflow so the team can move quickly without normalizing broken output.",
      "targetSystem": "staging.raw_customers.publish_job",
      "items": [
        {
          "id": "test-suite",
  ...
  "hints": [
    "Start by naming the business grain that transformation lineage should produce.",
  ...
  "careerInsight": "Pipeline teams create trust at scale by spotting data quality risk before it turns into broken reporting or missed SLAs. Transformation Lineage is a common scenario in interviews, production reviews, and cross-functional planning.",
  "toolRelevance": [
    "dbt",
    "Airflow",
    "BigQuery"
