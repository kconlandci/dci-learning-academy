...
export const schemaVersioningLab: LabManifest = LabManifestSchema.parse({
  "schemaVersion": "1.1",
  ...
  "description": "Practice schema versioning inside a realistic analytics workflow, choose the safest decision, and explain why it is the most trustworthy SQL or data move.",
  "estimatedMinutes": 18,
  "learningObjectives": [
    "Clarify the stakeholder need behind schema versioning.",
  ...
  "scenarios": [
    {
      ...
      "id": "schema-versioning-scenario-1",
      "title": "Investigate the surprising output",
      "objective": "A data architect flagged a surprising result while reviewing schema versioning. Inspect the evidence and decide the best next step before the metric is shared more widely.",
      "investigationData": [
        {
          "id": "source-query",
    ...
    {
      "type": "investigate-decide",
      "id": "schema-versioning-scenario-2",
      "title": "Resolve the freshness conflict",
      "objective": "Two teams are quoting different outputs for schema versioning. Review the evidence and decide how to respond.",
      "investigationData": [
        {
          "id": "source-dashboard",
    ...
    {
      "type": "investigate-decide",
      "id": "schema-versioning-scenario-3",
      "title": "Decide how to close the incident",
      "objective": "You have narrowed the issue behind schema versioning. Review the final evidence and choose the best closeout action.",
      "investigationData": [
        {
  ...
  "hints": [
    "Start by naming the business grain that schema versioning should produce.",
  ...
  "careerInsight": "Strong data modeling judgment helps teams avoid duplicated logic, brittle pipelines, and expensive rework. Schema Versioning is a common scenario in interviews, production reviews, and cross-functional planning.",
  "toolRelevance": [
    "dbdiagram.io",
    "PostgreSQL",
    "Flyway"
