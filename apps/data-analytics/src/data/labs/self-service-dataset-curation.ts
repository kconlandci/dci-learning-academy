...
export const selfServiceDatasetCurationLab: LabManifest = LabManifestSchema.parse({
  "schemaVersion": "1.1",
  "id": "self-service-dataset-curation",
  "version": 1,
  "title": "Self-Service Dataset Curation",
  "tier": "beginner",
  ...
  "description": "Practice self-service dataset curation inside a realistic analytics workflow, choose the safest decision, and explain why it is the most trustworthy SQL or data move.",
  "estimatedMinutes": 10,
  "learningObjectives": [
    "Clarify the stakeholder need behind self-service dataset curation.",
  ...
  "prerequisites": [
    {
      "labId": "reporting-grain-alignment",
      "minScore": 60
    }
  ],
  ...
  "scenarios": [
    {
      ...
      "id": "self-service-dataset-curation-scenario-1",
      "title": "Investigate the surprising output",
      "objective": "A sales director flagged a surprising result while reviewing self-service dataset curation. Inspect the evidence and decide the best next step before the metric is shared more widely.",
      "investigationData": [
        {
          "id": "source-query",
          "label": "Query Result Sample",
          "content": "Rows from bi.executive_scorecard show a 14% jump after a new join was added yesterday. Distinct entity count increased only 1%.",
          "isCritical": true
        },
        {
          "id": "source-note",
        ...
        },
        {
          ...
          "content": "The sales director needs a reliable explanation before presenting this number to leadership."
        }
      ],
      "actions": [
        {
    ...
    {
      "type": "investigate-decide",
      "id": "self-service-dataset-curation-scenario-2",
      "title": "Resolve the freshness conflict",
      "objective": "Two teams are quoting different outputs for self-service dataset curation. Review the evidence and decide how to respond.",
      "investigationData": [
        {
          "id": "source-dashboard",
        ...
        },
        {
          "id": "source-chat",
          "label": "Team Chat",
          "content": "The sales director asks whether the 08:00 dashboard can still be used for today's review."
        }
      ],
      "actions": [
        {
    ...
    {
      "type": "investigate-decide",
      "id": "self-service-dataset-curation-scenario-3",
      "title": "Decide how to close the incident",
      "objective": "You have narrowed the issue behind self-service dataset curation. Review the final evidence and choose the best closeout action.",
      "investigationData": [
        {
  ...
  "hints": [
    "Start by naming the business grain that self-service dataset curation should produce.",
  ...
  "careerInsight": "Good BI work is not just chart building; it is metric definition, stakeholder alignment, and clear storytelling. Self-Service Dataset Curation is a common scenario in interviews, production reviews, and cross-functional planning.",
  "toolRelevance": [
    "Looker",
    "Power BI",
    "Tableau"
