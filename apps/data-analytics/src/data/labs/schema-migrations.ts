...
export const schemaMigrationsLab: LabManifest = LabManifestSchema.parse({
  "schemaVersion": "1.1",
  ...
  "description": "Practice schema migrations inside a realistic analytics workflow, choose the safest decision, and explain why it is the most trustworthy SQL or data move.",
  "estimatedMinutes": 14,
  "learningObjectives": [
    "Clarify the stakeholder need behind schema migrations.",
  ...
  "scenarios": [
    {
      "type": "toggle-config",
      "id": "schema-migrations-scenario-1",
      "title": "Configure the default quality controls",
      "description": "You are preparing a shared asset for schema migrations. Set the defaults so the platform engineer gets trustworthy results without relying on tribal knowledge.",
      "targetSystem": "core.customer_dim.semantic_model",
      "items": [
        {
          "id": "grain-check",
      ...
      "feedback": {
        "perfect": "Great configuration. Schema Migrations becomes safer to reuse when quality checks, null policies, and reviews are explicit.",
    ...
    {
      "type": "toggle-config",
      "id": "schema-migrations-scenario-2",
      "title": "Set access and change controls",
      "description": "A wider audience wants self-service access to schema migrations. Configure the model so speed does not outrun governance.",
      "targetSystem": "core.customer_dim.reporting_view",
      "items": [
        {
          "id": "access-scope",
          "label": "Access Scope",
    ...
    {
      "type": "toggle-config",
      "id": "schema-migrations-scenario-3",
      "title": "Tune the publish workflow",
      "description": "The team wants a faster release cycle for schema migrations. Configure the publish workflow so the team can move quickly without normalizing broken output.",
      "targetSystem": "core.customer_dim.publish_job",
      "items": [
        {
          "id": "test-suite",
  ...
  "hints": [
    "Start by naming the business grain that schema migrations should produce.",
  ...
  "careerInsight": "Strong data modeling judgment helps teams avoid duplicated logic, brittle pipelines, and expensive rework. Schema Migrations is a common scenario in interviews, production reviews, and cross-functional planning.",
  "toolRelevance": [
    "dbdiagram.io",
    "PostgreSQL",
    "Flyway"
