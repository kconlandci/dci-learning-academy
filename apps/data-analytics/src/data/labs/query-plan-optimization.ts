...
export const queryPlanOptimizationLab: LabManifest = LabManifestSchema.parse({
  "schemaVersion": "1.1",
  "id": "query-plan-optimization",
  "version": 1,
  ...
  "description": "Practice query plan optimization inside a realistic analytics workflow, choose the safest decision, and explain why it is the most trustworthy SQL or data move.",
  "estimatedMinutes": 10,
  "learningObjectives": [
    "Clarify the stakeholder need behind query plan optimization.",
  ...
  "scenarios": [
    {
      "type": "toggle-config",
      "id": "query-plan-optimization-scenario-1",
      "title": "Configure the default quality controls",
      "description": "You are preparing a shared asset for query plan optimization. Set the defaults so the analytics engineering manager gets trustworthy results without relying on tribal knowledge.",
      ...
      "feedback": {
        "perfect": "Great configuration. Query Plan Optimization becomes safer to reuse when quality checks, null policies, and reviews are explicit.",
    ...
    {
      "type": "toggle-config",
      "id": "query-plan-optimization-scenario-2",
      "title": "Set access and change controls",
      "description": "A wider audience wants self-service access to query plan optimization. Configure the model so speed does not outrun governance.",
    ...
    {
      "type": "toggle-config",
      "id": "query-plan-optimization-scenario-3",
      "title": "Tune the publish workflow",
      "description": "The team wants a faster release cycle for query plan optimization. Configure the publish workflow so the team can move quickly without normalizing broken output.",
  ...
  "hints": [
    "Start by naming the business grain that query plan optimization should produce.",
  ...
  "careerInsight": "Advanced analytics work often separates solid SQL users from the engineers who can keep an entire warehouse fast and stable. Query Plan Optimization is a common scenario in interviews, production reviews, and cross-functional planning.",
  "toolRelevance": [
    "EXPLAIN plans",
    "Snowflake",
    "PostgreSQL"
