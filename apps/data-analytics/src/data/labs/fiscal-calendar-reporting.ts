...
export const fiscalCalendarReportingLab: LabManifest = LabManifestSchema.parse({
  "schemaVersion": "1.1",
  "id": "fiscal-calendar-reporting",
  "version": 1,
  "title": "Fiscal Calendar Reporting",
  "tier": "beginner",
  ...
  "description": "Practice fiscal calendar reporting inside a realistic analytics workflow, choose the safest decision, and explain why it is the most trustworthy SQL or data move.",
  "estimatedMinutes": 14,
  "learningObjectives": [
    "Clarify the stakeholder need behind fiscal calendar reporting.",
  ...
  "prerequisites": [
    {
      "labId": "self-service-dataset-curation",
      "minScore": 60
    }
  ],
  ...
  "scenarios": [
    {
      ...
      "id": "fiscal-calendar-reporting-scenario-1",
      "title": "Triage the broken result",
      "description": "A delivery team escalated fiscal calendar reporting after seeing an unexpected spike. Classify the issue, pick the right remediation, and explain your decision.",
      "evidence": [
        {
          "type": "query output",
          "content": "The bi.sales_pipeline result set doubled after a new dimension join was released."
        },
        {
          "type": "quality alert",
        ...
        },
        {
          ...
          "content": "The BI manager needs a trusted answer before tomorrow's review."
        }
      ],
      "classifications": [
        {
    ...
    {
      "type": "triage-remediate",
      "id": "fiscal-calendar-reporting-scenario-2",
      "title": "Classify the stale dashboard",
      "description": "A shared dashboard built on fiscal calendar reporting is stale after a failed refresh. Decide how to classify and remediate the issue.",
      "evidence": [
        {
          "type": "refresh log",
    ...
    {
      "type": "triage-remediate",
      "id": "fiscal-calendar-reporting-scenario-3",
      "title": "Close the definition mismatch",
      "description": "A metric built for fiscal calendar reporting changed meaning after a silent definition update. Classify the issue and choose the best remediation.",
      "evidence": [
        {
          "type": "change note",
        ...
        {
          "type": "owner feedback",
          "content": "The BI manager wants a correction, a root-cause note, and a safer handoff next time."
        }
      ],
      "classifications": [
        {
  ...
  "hints": [
    "Start by naming the business grain that fiscal calendar reporting should produce.",
  ...
  "careerInsight": "Good BI work is not just chart building; it is metric definition, stakeholder alignment, and clear storytelling. Fiscal Calendar Reporting is a common scenario in interviews, production reviews, and cross-functional planning.",
  "toolRelevance": [
    "Looker",
    "Power BI",
    "Tableau"
