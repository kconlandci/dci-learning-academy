...
export const aggregateMetricsLab: LabManifest = LabManifestSchema.parse({
  "schemaVersion": "1.1",
  ...
  "description": "Practice aggregate metrics inside a realistic analytics workflow, choose the safest decision, and explain why it is the most trustworthy SQL or data move.",
  "estimatedMinutes": 14,
  "learningObjectives": [
    "Clarify the stakeholder need behind aggregate metrics.",
  ...
  "scenarios": [
    {
      ...
      "id": "aggregate-metrics-scenario-1",
      "title": "Triage the broken result",
      "description": "A delivery team escalated aggregate metrics after seeing an unexpected spike. Classify the issue, pick the right remediation, and explain your decision.",
      "evidence": [
        {
          "type": "query output",
          "content": "The warehouse.orders result set doubled after a new dimension join was released."
        },
        {
          "type": "quality alert",
        ...
        },
        {
          ...
          "content": "The operations manager needs a trusted answer before tomorrow's review."
        }
      ],
      "classifications": [
        {
    ...
    {
      "type": "triage-remediate",
      "id": "aggregate-metrics-scenario-2",
      "title": "Classify the stale dashboard",
      "description": "A shared dashboard built on aggregate metrics is stale after a failed refresh. Decide how to classify and remediate the issue.",
      "evidence": [
        {
          "type": "refresh log",
    ...
    {
      "type": "triage-remediate",
      "id": "aggregate-metrics-scenario-3",
      "title": "Close the definition mismatch",
      "description": "A metric built for aggregate metrics changed meaning after a silent definition update. Classify the issue and choose the best remediation.",
      "evidence": [
        {
          "type": "change note",
        ...
        {
          "type": "owner feedback",
          "content": "The operations manager wants a correction, a root-cause note, and a safer handoff next time."
        }
      ],
      "classifications": [
        {
  ...
  "hints": [
    "Start by naming the business grain that aggregate metrics should produce.",
  ...
  "careerInsight": "Reliable SQL fundamentals are the fastest way to become useful on analytics, reporting, and data engineering teams. Aggregate Metrics is a common scenario in interviews, production reviews, and cross-functional planning.",
  "toolRelevance": [
    "PostgreSQL",
    "SQLite",
    "DBeaver"
