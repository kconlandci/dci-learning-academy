...
export const leftJoinsLab: LabManifest = LabManifestSchema.parse({
  "schemaVersion": "1.1",
  "id": "left-joins",
  "version": 1,
  "title": "Left Joins",
  ...
  "description": "Practice left joins inside a realistic analytics workflow, choose the safest decision, and explain why it is the most trustworthy SQL or data move.",
  "estimatedMinutes": 14,
  "learningObjectives": [
    "Clarify the stakeholder need behind left joins.",
  ...
  "scenarios": [
    {
      ...
      "id": "left-joins-scenario-1",
      "title": "Triage the broken result",
      "description": "A delivery team escalated left joins after seeing an unexpected spike. Classify the issue, pick the right remediation, and explain your decision.",
      "evidence": [
        {
          "type": "query output",
    ...
    {
      "type": "triage-remediate",
      "id": "left-joins-scenario-2",
      "title": "Classify the stale dashboard",
      "description": "A shared dashboard built on left joins is stale after a failed refresh. Decide how to classify and remediate the issue.",
      "evidence": [
        {
          "type": "refresh log",
    ...
    {
      "type": "triage-remediate",
      "id": "left-joins-scenario-3",
      "title": "Close the definition mismatch",
      "description": "A metric built for left joins changed meaning after a silent definition update. Classify the issue and choose the best remediation.",
      "evidence": [
        {
          "type": "change note",
  ...
  "hints": [
    "Start by naming the business grain that left joins should produce.",
  ...
  "careerInsight": "Reliable SQL fundamentals are the fastest way to become useful on analytics, reporting, and data engineering teams. Left Joins is a common scenario in interviews, production reviews, and cross-functional planning.",
  "toolRelevance": [
    "PostgreSQL",
    "SQLite",
    "DBeaver"
