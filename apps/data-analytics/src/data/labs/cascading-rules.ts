...
export const cascadingRulesLab: LabManifest = LabManifestSchema.parse({
  "schemaVersion": "1.1",
  "id": "cascading-rules",
  "version": 1,
  ...
  "description": "Practice cascading rules inside a realistic analytics workflow, choose the safest decision, and explain why it is the most trustworthy SQL or data move.",
  "estimatedMinutes": 18,
  "learningObjectives": [
    "Clarify the stakeholder need behind cascading rules.",
  ...
  "scenarios": [
    {
      ...
      "id": "cascading-rules-scenario-1",
      "title": "Choose the strongest SQL approach",
      "context": "backend lead needs a reliable answer for cascading rules before the weekly review. Pick the action that keeps the query auditable and the result grain stable under deadline pressure.",
      "displayFields": [
        {
          "label": "Dataset",
      ...
      "feedback": {
        "perfect": "Excellent. Cascading Rules is strongest when you keep the grain explicit and validate the joins before sharing a metric.",
        ...
        "wrong": "That choice adds avoidable risk. For cascading rules, the best move is the option that stays reviewable and grain-aware."
      }
    },
    {
      "type": "action-rationale",
      "id": "cascading-rules-scenario-2",
      "title": "Handle the stakeholder follow-up",
      "context": "After your first draft, the backend lead asks for one more slice of cascading rules by region. Decide how to respond without turning a clean query into a fragile one-off.",
      "displayFields": [
        {
          "label": "Current asset",
          "value": "cascading-rules_draft.sql"
        },
        {
    ...
    {
      "type": "action-rationale",
      "id": "cascading-rules-scenario-3",
      "title": "Explain why the result is trustworthy",
      "context": "You are presenting cascading rules in a team review. Choose the explanation that best demonstrates sound analytics judgment.",
      "displayFields": [
        {
          "label": "Audience",
  ...
  "hints": [
    "Start by naming the business grain that cascading rules should produce.",
  ...
  "careerInsight": "Strong data modeling judgment helps teams avoid duplicated logic, brittle pipelines, and expensive rework. Cascading Rules is a common scenario in interviews, production reviews, and cross-functional planning.",
  "toolRelevance": [
    "dbdiagram.io",
    "PostgreSQL",
    "Flyway"
