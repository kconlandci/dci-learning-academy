...
export const cohortRetentionLab: LabManifest = LabManifestSchema.parse({
  "schemaVersion": "1.1",
  "id": "cohort-retention",
  "version": 1,
  ...
  "description": "Practice cohort retention inside a realistic analytics workflow, choose the safest decision, and explain why it is the most trustworthy SQL or data move.",
  "estimatedMinutes": 10,
  "learningObjectives": [
    "Clarify the stakeholder need behind cohort retention.",
  ...
  "scenarios": [
    {
      ...
      "id": "cohort-retention-scenario-1",
      "title": "Triage the broken result",
      "description": "A delivery team escalated cohort retention after seeing an unexpected spike. Classify the issue, pick the right remediation, and explain your decision.",
      "evidence": [
        {
          "type": "query output",
    ...
    {
      "type": "triage-remediate",
      "id": "cohort-retention-scenario-2",
      "title": "Classify the stale dashboard",
      "description": "A shared dashboard built on cohort retention is stale after a failed refresh. Decide how to classify and remediate the issue.",
      "evidence": [
        {
          "type": "refresh log",
    ...
    {
      "type": "triage-remediate",
      "id": "cohort-retention-scenario-3",
      "title": "Close the definition mismatch",
      "description": "A metric built for cohort retention changed meaning after a silent definition update. Classify the issue and choose the best remediation.",
      "evidence": [
        {
          "type": "change note",
  ...
  "hints": [
    "Start by naming the business grain that cohort retention should produce.",
  ...
  "careerInsight": "Analysts who can explain trends with clean SQL and defensible logic become the people leaders trust in decision meetings. Cohort Retention is a common scenario in interviews, production reviews, and cross-functional planning.",
  "toolRelevance": [
    "DuckDB",
    "BigQuery",
    "Looker Studio"
