...
export const drillDownPathsLab: LabManifest = LabManifestSchema.parse({
  "schemaVersion": "1.1",
  "id": "drill-down-paths",
  "version": 1,
  ...
  "description": "Practice drill down paths inside a realistic analytics workflow, choose the safest decision, and explain why it is the most trustworthy SQL or data move.",
  "estimatedMinutes": 18,
  "learningObjectives": [
    "Clarify the stakeholder need behind drill down paths.",
  ...
  "prerequisites": [
    {
      "labId": "stakeholder-metric-definitions",
      "minScore": 60
    }
  ],
  ...
  "scenarios": [
    {
      ...
      "id": "drill-down-paths-scenario-1",
      "title": "Investigate the surprising output",
      "objective": "A BI manager flagged a surprising result while reviewing drill down paths. Inspect the evidence and decide the best next step before the metric is shared more widely.",
      "investigationData": [
        {
          "id": "source-query",
    ...
    {
      "type": "investigate-decide",
      "id": "drill-down-paths-scenario-2",
      "title": "Resolve the freshness conflict",
      "objective": "Two teams are quoting different outputs for drill down paths. Review the evidence and decide how to respond.",
      "investigationData": [
        {
          "id": "source-dashboard",
    ...
    {
      "type": "investigate-decide",
      "id": "drill-down-paths-scenario-3",
      "title": "Decide how to close the incident",
      "objective": "You have narrowed the issue behind drill down paths. Review the final evidence and choose the best closeout action.",
      "investigationData": [
        {
  ...
  "hints": [
    "Start by naming the business grain that drill down paths should produce.",
  ...
  "careerInsight": "Good BI work is not just chart building; it is metric definition, stakeholder alignment, and clear storytelling. Drill Down Paths is a common scenario in interviews, production reviews, and cross-functional planning.",
  "toolRelevance": [
    "Looker",
    "Power BI",
    "Tableau"
