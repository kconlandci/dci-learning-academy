...
export const multiTableJoinsLab: LabManifest = LabManifestSchema.parse({
  "schemaVersion": "1.1",
  ...
  "description": "Practice multi-table joins inside a realistic analytics workflow, choose the safest decision, and explain why it is the most trustworthy SQL or data move.",
  "estimatedMinutes": 14,
  "learningObjectives": [
    "Clarify the stakeholder need behind multi-table joins.",
  ...
  "scenarios": [
    {
      ...
      "id": "multi-table-joins-scenario-1",
      "title": "Choose the strongest SQL approach",
      "context": "product manager needs a reliable answer for multi-table joins before the weekly review. Pick the action that keeps the query auditable and the result grain stable under deadline pressure.",
      "displayFields": [
        {
          "label": "Dataset",
      ...
      "feedback": {
        "perfect": "Excellent. Multi-Table Joins is strongest when you keep the grain explicit and validate the joins before sharing a metric.",
        ...
        "wrong": "That choice adds avoidable risk. For multi-table joins, the best move is the option that stays reviewable and grain-aware."
      }
    },
    {
      "type": "action-rationale",
      "id": "multi-table-joins-scenario-2",
      "title": "Handle the stakeholder follow-up",
      "context": "After your first draft, the product manager asks for one more slice of multi-table joins by region. Decide how to respond without turning a clean query into a fragile one-off.",
      "displayFields": [
        {
          "label": "Current asset",
          "value": "multi-table-joins_draft.sql"
        },
        {
    ...
    {
      "type": "action-rationale",
      "id": "multi-table-joins-scenario-3",
      "title": "Explain why the result is trustworthy",
      "context": "You are presenting multi-table joins in a team review. Choose the explanation that best demonstrates sound analytics judgment.",
      "displayFields": [
        {
          "label": "Audience",
  ...
  "hints": [
    "Start by naming the business grain that multi-table joins should produce.",
  ...
  "careerInsight": "Reliable SQL fundamentals are the fastest way to become useful on analytics, reporting, and data engineering teams. Multi-Table Joins is a common scenario in interviews, production reviews, and cross-functional planning.",
  "toolRelevance": [
    "PostgreSQL",
    "SQLite",
    "DBeaver"
