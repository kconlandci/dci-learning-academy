...
export const nullImputationPolicyLab: LabManifest = LabManifestSchema.parse({
  "schemaVersion": "1.1",
  "id": "null-imputation-policy",
  "version": 1,
  "title": "Null Imputation Policy",
  "tier": "beginner",
  ...
  "description": "Practice null imputation policy inside a realistic analytics workflow, choose the safest decision, and explain why it is the most trustworthy SQL or data move.",
  "estimatedMinutes": 10,
  "learningObjectives": [
    "Clarify the stakeholder need behind null imputation policy.",
  ...
  "scenarios": [
    {
      ...
      "id": "null-imputation-policy-scenario-1",
      "title": "Investigate the surprising output",
      "objective": "A analytics engineer flagged a surprising result while reviewing null imputation policy. Inspect the evidence and decide the best next step before the metric is shared more widely.",
      "investigationData": [
        {
          "id": "source-query",
          "label": "Query Result Sample",
          "content": "Rows from orchestration.pipeline_runs show a 14% jump after a new join was added yesterday. Distinct entity count increased only 1%.",
          "isCritical": true
        },
        {
          "id": "source-note",
        ...
        },
        {
          ...
          "content": "The analytics engineer needs a reliable explanation before presenting this number to leadership."
        }
      ],
      "actions": [
        {
    ...
    {
      "type": "investigate-decide",
      "id": "null-imputation-policy-scenario-2",
      "title": "Resolve the freshness conflict",
      "objective": "Two teams are quoting different outputs for null imputation policy. Review the evidence and decide how to respond.",
      "investigationData": [
        {
          "id": "source-dashboard",
        ...
        },
        {
          "id": "source-chat",
          "label": "Team Chat",
          "content": "The analytics engineer asks whether the 08:00 dashboard can still be used for today's review."
        }
      ],
      "actions": [
        {
    ...
    {
      "type": "investigate-decide",
      "id": "null-imputation-policy-scenario-3",
      "title": "Decide how to close the incident",
      "objective": "You have narrowed the issue behind null imputation policy. Review the final evidence and choose the best closeout action.",
      "investigationData": [
        {
  ...
  "hints": [
    "Start by naming the business grain that null imputation policy should produce.",
  ...
  "careerInsight": "Pipeline teams create trust at scale by spotting data quality risk before it turns into broken reporting or missed SLAs. Null Imputation Policy is a common scenario in interviews, production reviews, and cross-functional planning.",
  "toolRelevance": [
    "dbt",
    "Airflow",
    "BigQuery"
