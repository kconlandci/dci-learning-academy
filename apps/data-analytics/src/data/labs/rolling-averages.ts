...
export const rollingAveragesLab: LabManifest = LabManifestSchema.parse({
  "schemaVersion": "1.1",
  "id": "rolling-averages",
  "version": 1,
  ...
  "description": "Practice rolling averages inside a realistic analytics workflow, choose the safest decision, and explain why it is the most trustworthy SQL or data move.",
  "estimatedMinutes": 10,
  "learningObjectives": [
    "Clarify the stakeholder need behind rolling averages.",
  ...
  "scenarios": [
    {
      ...
      "id": "rolling-averages-scenario-1",
      "title": "Choose the strongest SQL approach",
      "context": "go-to-market lead needs a reliable answer for rolling averages before the weekly review. Pick the action that keeps the query auditable and the result grain stable under deadline pressure.",
      "displayFields": [
        {
          "label": "Dataset",
      ...
      "feedback": {
        "perfect": "Excellent. Rolling Averages is strongest when you keep the grain explicit and validate the joins before sharing a metric.",
        ...
        "wrong": "That choice adds avoidable risk. For rolling averages, the best move is the option that stays reviewable and grain-aware."
      }
    },
    {
      "type": "action-rationale",
      "id": "rolling-averages-scenario-2",
      "title": "Handle the stakeholder follow-up",
      "context": "After your first draft, the go-to-market lead asks for one more slice of rolling averages by region. Decide how to respond without turning a clean query into a fragile one-off.",
      "displayFields": [
        {
          "label": "Current asset",
          "value": "rolling-averages_draft.sql"
        },
        {
    ...
    {
      "type": "action-rationale",
      "id": "rolling-averages-scenario-3",
      "title": "Explain why the result is trustworthy",
      "context": "You are presenting rolling averages in a team review. Choose the explanation that best demonstrates sound analytics judgment.",
      "displayFields": [
        {
          "label": "Audience",
  ...
  "hints": [
    "Start by naming the business grain that rolling averages should produce.",
  ...
  "careerInsight": "Analysts who can explain trends with clean SQL and defensible logic become the people leaders trust in decision meetings. Rolling Averages is a common scenario in interviews, production reviews, and cross-functional planning.",
  "toolRelevance": [
    "DuckDB",
    "BigQuery",
    "Looker Studio"
