...
export const funnelAnalysisLab: LabManifest = LabManifestSchema.parse({
  "schemaVersion": "1.1",
  "id": "funnel-analysis",
  "version": 1,
  ...
  "description": "Practice funnel analysis inside a realistic analytics workflow, choose the safest decision, and explain why it is the most trustworthy SQL or data move.",
  "estimatedMinutes": 10,
  "learningObjectives": [
    "Clarify the stakeholder need behind funnel analysis.",
  ...
  "scenarios": [
    {
      "type": "toggle-config",
      "id": "funnel-analysis-scenario-1",
      "title": "Configure the default quality controls",
      "description": "You are preparing a shared asset for funnel analysis. Set the defaults so the go-to-market lead gets trustworthy results without relying on tribal knowledge.",
      ...
      "feedback": {
        "perfect": "Great configuration. Funnel Analysis becomes safer to reuse when quality checks, null policies, and reviews are explicit.",
    ...
    {
      "type": "toggle-config",
      "id": "funnel-analysis-scenario-2",
      "title": "Set access and change controls",
      "description": "A wider audience wants self-service access to funnel analysis. Configure the model so speed does not outrun governance.",
    ...
    {
      "type": "toggle-config",
      "id": "funnel-analysis-scenario-3",
      "title": "Tune the publish workflow",
      "description": "The team wants a faster release cycle for funnel analysis. Configure the publish workflow so the team can move quickly without normalizing broken output.",
  ...
  "hints": [
    "Start by naming the business grain that funnel analysis should produce.",
  ...
  "careerInsight": "Analysts who can explain trends with clean SQL and defensible logic become the people leaders trust in decision meetings. Funnel Analysis is a common scenario in interviews, production reviews, and cross-functional planning.",
  "toolRelevance": [
    "DuckDB",
    "BigQuery",
    "Looker Studio"
