...
export const churnSignalAnalysisLab: LabManifest = LabManifestSchema.parse({
  "schemaVersion": "1.1",
  "id": "churn-signal-analysis",
  "version": 1,
  ...
  "description": "Practice churn signal analysis inside a realistic analytics workflow, choose the safest decision, and explain why it is the most trustworthy SQL or data move.",
  "estimatedMinutes": 18,
  "learningObjectives": [
    "Clarify the stakeholder need behind churn signal analysis.",
  ...
  "prerequisites": [
    {
      "labId": "inventory-turnover-analysis",
      "minScore": 60
    }
  ],
  ...
  "scenarios": [
    {
      ...
      "id": "churn-signal-analysis-scenario-1",
      "title": "Investigate the surprising output",
      "objective": "A go-to-market lead flagged a surprising result while reviewing churn signal analysis. Inspect the evidence and decide the best next step before the metric is shared more widely.",
      "investigationData": [
        {
          "id": "source-query",
          "label": "Query Result Sample",
          "content": "Rows from mart.customer_cohorts show a 14% jump after a new join was added yesterday. Distinct entity count increased only 1%.",
          "isCritical": true
        },
        {
          "id": "source-note",
        ...
        },
        {
          ...
          "content": "The go-to-market lead needs a reliable explanation before presenting this number to leadership."
        }
      ],
      "actions": [
        {
    ...
    {
      "type": "investigate-decide",
      "id": "churn-signal-analysis-scenario-2",
      "title": "Resolve the freshness conflict",
      "objective": "Two teams are quoting different outputs for churn signal analysis. Review the evidence and decide how to respond.",
      "investigationData": [
        {
          "id": "source-dashboard",
        ...
        },
        {
          "id": "source-chat",
          "label": "Team Chat",
          "content": "The go-to-market lead asks whether the 08:00 dashboard can still be used for today's review."
        }
      ],
      "actions": [
        {
    ...
    {
      "type": "investigate-decide",
      "id": "churn-signal-analysis-scenario-3",
      "title": "Decide how to close the incident",
      "objective": "You have narrowed the issue behind churn signal analysis. Review the final evidence and choose the best closeout action.",
      "investigationData": [
        {
  ...
  "hints": [
    "Start by naming the business grain that churn signal analysis should produce.",
  ...
  "careerInsight": "Analysts who can explain trends with clean SQL and defensible logic become the people leaders trust in decision meetings. Churn Signal Analysis is a common scenario in interviews, production reviews, and cross-functional planning.",
  "toolRelevance": [
    "DuckDB",
    "BigQuery",
    "Looker Studio"
