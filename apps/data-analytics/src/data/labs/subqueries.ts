...
export const subqueriesLab: LabManifest = LabManifestSchema.parse({
  "schemaVersion": "1.1",
  "id": "subqueries",
  "version": 1,
  "title": "Subqueries",
  ...
  "description": "Practice subqueries inside a realistic analytics workflow, choose the safest decision, and explain why it is the most trustworthy SQL or data move.",
  "estimatedMinutes": 14,
  "learningObjectives": [
    "Clarify the stakeholder need behind subqueries.",
  ...
  "scenarios": [
    {
      ...
      "id": "subqueries-scenario-1",
      "title": "Investigate the surprising output",
      "objective": "A product manager flagged a surprising result while reviewing subqueries. Inspect the evidence and decide the best next step before the metric is shared more widely.",
      "investigationData": [
        {
          "id": "source-query",
    ...
    {
      "type": "investigate-decide",
      "id": "subqueries-scenario-2",
      "title": "Resolve the freshness conflict",
      "objective": "Two teams are quoting different outputs for subqueries. Review the evidence and decide how to respond.",
      "investigationData": [
        {
          "id": "source-dashboard",
    ...
    {
      "type": "investigate-decide",
      "id": "subqueries-scenario-3",
      "title": "Decide how to close the incident",
      "objective": "You have narrowed the issue behind subqueries. Review the final evidence and choose the best closeout action.",
      "investigationData": [
        {
  ...
  "hints": [
    "Start by naming the business grain that subqueries should produce.",
  ...
  "careerInsight": "Reliable SQL fundamentals are the fastest way to become useful on analytics, reporting, and data engineering teams. Subqueries is a common scenario in interviews, production reviews, and cross-functional planning.",
  "toolRelevance": [
    "PostgreSQL",
    "SQLite",
    "DBeaver"
