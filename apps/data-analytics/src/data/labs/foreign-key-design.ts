...
export const foreignKeyDesignLab: LabManifest = LabManifestSchema.parse({
  "schemaVersion": "1.1",
  "id": "foreign-key-design",
  "version": 1,
  ...
  "description": "Practice foreign key design inside a realistic analytics workflow, choose the safest decision, and explain why it is the most trustworthy SQL or data move.",
  "estimatedMinutes": 10,
  "learningObjectives": [
    "Clarify the stakeholder need behind foreign key design.",
  ...
  "prerequisites": [
    {
      "labId": "primary-vs-surrogate-keys",
      "minScore": 60
    }
  ],
  ...
  "scenarios": [
    {
      ...
      "id": "foreign-key-design-scenario-1",
      "title": "Triage the broken result",
      "description": "A delivery team escalated foreign key design after seeing an unexpected spike. Classify the issue, pick the right remediation, and explain your decision.",
      "evidence": [
        {
          "type": "query output",
          "content": "The core.customer_dim result set doubled after a new dimension join was released."
        },
        {
          "type": "quality alert",
        ...
        },
        {
          ...
          "content": "The platform engineer needs a trusted answer before tomorrow's review."
        }
      ],
      "classifications": [
        {
    ...
    {
      "type": "triage-remediate",
      "id": "foreign-key-design-scenario-2",
      "title": "Classify the stale dashboard",
      "description": "A shared dashboard built on foreign key design is stale after a failed refresh. Decide how to classify and remediate the issue.",
      "evidence": [
        {
          "type": "refresh log",
    ...
    {
      "type": "triage-remediate",
      "id": "foreign-key-design-scenario-3",
      "title": "Close the definition mismatch",
      "description": "A metric built for foreign key design changed meaning after a silent definition update. Classify the issue and choose the best remediation.",
      "evidence": [
        {
          "type": "change note",
        ...
        {
          "type": "owner feedback",
          "content": "The platform engineer wants a correction, a root-cause note, and a safer handoff next time."
        }
      ],
      "classifications": [
        {
  ...
  "hints": [
    "Start by naming the business grain that foreign key design should produce.",
  ...
  "careerInsight": "Strong data modeling judgment helps teams avoid duplicated logic, brittle pipelines, and expensive rework. Foreign Key Design is a common scenario in interviews, production reviews, and cross-functional planning.",
  "toolRelevance": [
    "dbdiagram.io",
    "PostgreSQL",
    "Flyway"
