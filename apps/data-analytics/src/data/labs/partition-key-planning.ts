...
export const partitionKeyPlanningLab: LabManifest = LabManifestSchema.parse({
  "schemaVersion": "1.1",
  "id": "partition-key-planning",
  "version": 1,
  "title": "Partition Key Planning",
  "tier": "intermediate",
  ...
  "description": "Practice partition key planning inside a realistic analytics workflow, choose the safest decision, and explain why it is the most trustworthy SQL or data move.",
  "estimatedMinutes": 14,
  "learningObjectives": [
    "Clarify the stakeholder need behind partition key planning.",
    "Choose a reliable SQL or analytics pattern for database design.",
  ...
  "scenarios": [
    {
      ...
      "id": "partition-key-planning-scenario-1",
      "title": "Choose the strongest SQL approach",
      "context": "data architect needs a reliable answer for partition key planning before the weekly review. Pick the action that keeps the query auditable and the result grain stable under deadline pressure.",
      "displayFields": [
        {
          "label": "Dataset",
          "value": "core.subscription_events"
        },
        {
          "label": "Deadline",
          "value": "30 minutes",
      ...
      "feedback": {
        "perfect": "Excellent. Partition Key Planning is strongest when you keep the grain explicit and validate the joins before sharing a metric.",
        ...
        "wrong": "That choice adds avoidable risk. For partition key planning, the best move is the option that stays reviewable and grain-aware."
      }
    },
    {
      "type": "action-rationale",
      "id": "partition-key-planning-scenario-2",
      "title": "Handle the stakeholder follow-up",
      "context": "After your first draft, the data architect asks for one more slice of partition key planning by region. Decide how to respond without turning a clean query into a fragile one-off.",
      "displayFields": [
        {
          "label": "Current asset",
          "value": "partition-key-planning_draft.sql"
        },
        {
    ...
    {
      "type": "action-rationale",
      "id": "partition-key-planning-scenario-3",
      "title": "Explain why the result is trustworthy",
      "context": "You are presenting partition key planning in a team review. Choose the explanation that best demonstrates sound analytics judgment.",
      "displayFields": [
        {
          "label": "Audience",
  ...
  "hints": [
    "Start by naming the business grain that partition key planning should produce.",
  ...
  "careerInsight": "Strong data modeling judgment helps teams avoid duplicated logic, brittle pipelines, and expensive rework. Partition Key Planning is a common scenario in interviews, production reviews, and cross-functional planning.",
  "toolRelevance": [
    "dbdiagram.io",
    "PostgreSQL",
    "Flyway"
