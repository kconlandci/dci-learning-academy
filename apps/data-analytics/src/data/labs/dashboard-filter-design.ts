...
export const dashboardFilterDesignLab: LabManifest = LabManifestSchema.parse({
  "schemaVersion": "1.1",
  "id": "dashboard-filter-design",
  "version": 1,
  "title": "Dashboard Filter Design",
  "tier": "beginner",
  ...
  "description": "Practice dashboard filter design inside a realistic analytics workflow, choose the safest decision, and explain why it is the most trustworthy SQL or data move.",
  "estimatedMinutes": 10,
  "learningObjectives": [
    "Clarify the stakeholder need behind dashboard filter design.",
  ...
  "scenarios": [
    {
      ...
      "id": "dashboard-filter-design-scenario-1",
      "title": "Triage the broken result",
      "description": "A delivery team escalated dashboard filter design after seeing an unexpected spike. Classify the issue, pick the right remediation, and explain your decision.",
      "evidence": [
        {
          "type": "query output",
    ...
    {
      "type": "triage-remediate",
      "id": "dashboard-filter-design-scenario-2",
      "title": "Classify the stale dashboard",
      "description": "A shared dashboard built on dashboard filter design is stale after a failed refresh. Decide how to classify and remediate the issue.",
      "evidence": [
        {
          "type": "refresh log",
    ...
    {
      "type": "triage-remediate",
      "id": "dashboard-filter-design-scenario-3",
      "title": "Close the definition mismatch",
      "description": "A metric built for dashboard filter design changed meaning after a silent definition update. Classify the issue and choose the best remediation.",
      "evidence": [
        {
          "type": "change note",
  ...
  "hints": [
    "Start by naming the business grain that dashboard filter design should produce.",
  ...
  "careerInsight": "Good BI work is not just chart building; it is metric definition, stakeholder alignment, and clear storytelling. Dashboard Filter Design is a common scenario in interviews, production reviews, and cross-functional planning.",
  "toolRelevance": [
    "Looker",
    "Power BI",
    "Tableau"
