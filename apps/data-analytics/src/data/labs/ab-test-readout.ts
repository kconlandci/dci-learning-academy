...
export const abTestReadoutLab: LabManifest = LabManifestSchema.parse({
  "schemaVersion": "1.1",
  "id": "ab-test-readout",
  "version": 1,
  ...
  "description": "Practice a/b test readout inside a realistic analytics workflow, choose the safest decision, and explain why it is the most trustworthy SQL or data move.",
  "estimatedMinutes": 18,
  "learningObjectives": [
    "Clarify the stakeholder need behind a/b test readout.",
  ...
  "prerequisites": [
    {
      "labId": "confidence-interval-prep",
      "minScore": 60
    }
  ],
  ...
  "scenarios": [
    {
      ...
      "id": "ab-test-readout-scenario-1",
      "title": "Choose the strongest SQL approach",
      "context": "growth analyst needs a reliable answer for a/b test readout before the weekly review. Pick the action that keeps the query auditable and the result grain stable under deadline pressure.",
      "displayFields": [
        {
          "label": "Dataset",
      ...
      "feedback": {
        "perfect": "Excellent. A/B Test Readout is strongest when you keep the grain explicit and validate the joins before sharing a metric.",
        ...
        "wrong": "That choice adds avoidable risk. For a/b test readout, the best move is the option that stays reviewable and grain-aware."
      }
    },
    {
      "type": "action-rationale",
      "id": "ab-test-readout-scenario-2",
      "title": "Handle the stakeholder follow-up",
      "context": "After your first draft, the growth analyst asks for one more slice of a/b test readout by region. Decide how to respond without turning a clean query into a fragile one-off.",
      "displayFields": [
        {
          "label": "Current asset",
          "value": "ab-test-readout_draft.sql"
        },
        {
    ...
    {
      "type": "action-rationale",
      "id": "ab-test-readout-scenario-3",
      "title": "Explain why the result is trustworthy",
      "context": "You are presenting a/b test readout in a team review. Choose the explanation that best demonstrates sound analytics judgment.",
      "displayFields": [
        {
          "label": "Audience",
  ...
  "hints": [
    "Start by naming the business grain that a/b test readout should produce.",
  ...
  "careerInsight": "Analysts who can explain trends with clean SQL and defensible logic become the people leaders trust in decision meetings. A/B Test Readout is a common scenario in interviews, production reviews, and cross-functional planning.",
  "toolRelevance": [
    "DuckDB",
    "BigQuery",
    "Looker Studio"
