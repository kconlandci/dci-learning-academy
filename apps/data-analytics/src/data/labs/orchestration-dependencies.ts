...
export const orchestrationDependenciesLab: LabManifest = LabManifestSchema.parse({
  "schemaVersion": "1.1",
  "id": "orchestration-dependencies",
  "version": 1,
  "title": "Orchestration Dependencies",
  "tier": "intermediate",
  ...
  "description": "Practice orchestration dependencies inside a realistic analytics workflow, choose the safest decision, and explain why it is the most trustworthy SQL or data move.",
  "estimatedMinutes": 14,
  "learningObjectives": [
    "Clarify the stakeholder need behind orchestration dependencies.",
  ...
  "scenarios": [
    {
      ...
      "id": "orchestration-dependencies-scenario-1",
      "title": "Investigate the surprising output",
      "objective": "A platform manager flagged a surprising result while reviewing orchestration dependencies. Inspect the evidence and decide the best next step before the metric is shared more widely.",
      "investigationData": [
        {
          "id": "source-query",
          "label": "Query Result Sample",
          "content": "Rows from staging.raw_customers show a 14% jump after a new join was added yesterday. Distinct entity count increased only 1%.",
          "isCritical": true
        },
        {
          "id": "source-note",
        ...
        },
        {
          ...
          "content": "The platform manager needs a reliable explanation before presenting this number to leadership."
        }
      ],
      "actions": [
        {
    ...
    {
      "type": "investigate-decide",
      "id": "orchestration-dependencies-scenario-2",
      "title": "Resolve the freshness conflict",
      "objective": "Two teams are quoting different outputs for orchestration dependencies. Review the evidence and decide how to respond.",
      "investigationData": [
        {
          "id": "source-dashboard",
        ...
        },
        {
          "id": "source-chat",
          "label": "Team Chat",
          "content": "The platform manager asks whether the 08:00 dashboard can still be used for today's review."
        }
      ],
      "actions": [
        {
    ...
    {
      "type": "investigate-decide",
      "id": "orchestration-dependencies-scenario-3",
      "title": "Decide how to close the incident",
      "objective": "You have narrowed the issue behind orchestration dependencies. Review the final evidence and choose the best closeout action.",
      "investigationData": [
        {
  ...
  "hints": [
    "Start by naming the business grain that orchestration dependencies should produce.",
  ...
  "careerInsight": "Pipeline teams create trust at scale by spotting data quality risk before it turns into broken reporting or missed SLAs. Orchestration Dependencies is a common scenario in interviews, production reviews, and cross-functional planning.",
  "toolRelevance": [
    "dbt",
    "Airflow",
    "BigQuery"
