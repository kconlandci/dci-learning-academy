...
export const medianWithWindowFunctionsLab: LabManifest = LabManifestSchema.parse({
  "schemaVersion": "1.1",
  "id": "median-with-window-functions",
  "version": 1,
  "title": "Median with Window Functions",
  "tier": "beginner",
  "track": "Data Analysis",
  "difficulty": "easy",
  "accessLevel": "free",
  ...
  "description": "Practice median with window functions inside a realistic analytics workflow, choose the safest decision, and explain why it is the most trustworthy SQL or data move.",
  "estimatedMinutes": 10,
  "learningObjectives": [
    "Clarify the stakeholder need behind median with window functions.",
  ...
  "scenarios": [
    {
      ...
      "id": "median-with-window-functions-scenario-1",
      "title": "Investigate the surprising output",
      "objective": "A finance partner flagged a surprising result while reviewing median with window functions. Inspect the evidence and decide the best next step before the metric is shared more widely.",
      "investigationData": [
        {
          "id": "source-query",
    ...
    {
      "type": "investigate-decide",
      "id": "median-with-window-functions-scenario-2",
      "title": "Resolve the freshness conflict",
      "objective": "Two teams are quoting different outputs for median with window functions. Review the evidence and decide how to respond.",
      "investigationData": [
        {
          "id": "source-dashboard",
    ...
    {
      "type": "investigate-decide",
      "id": "median-with-window-functions-scenario-3",
      "title": "Decide how to close the incident",
      "objective": "You have narrowed the issue behind median with window functions. Review the final evidence and choose the best closeout action.",
      "investigationData": [
        {
  ...
  "hints": [
    "Start by naming the business grain that median with window functions should produce.",
  ...
  "careerInsight": "Analysts who can explain trends with clean SQL and defensible logic become the people leaders trust in decision meetings. Median with Window Functions is a common scenario in interviews, production reviews, and cross-functional planning.",
  "toolRelevance": [
    "DuckDB",
    "BigQuery",
    "Looker Studio"
