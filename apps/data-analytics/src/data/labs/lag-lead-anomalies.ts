...
export const lagLeadAnomaliesLab: LabManifest = LabManifestSchema.parse({
  "schemaVersion": "1.1",
  "id": "lag-lead-anomalies",
  "version": 1,
  "title": "Lag and Lead Anomalies",
  "tier": "beginner",
  "track": "Data Analysis",
  "difficulty": "easy",
  "accessLevel": "free",
  ...
  "description": "Practice lag and lead anomalies inside a realistic analytics workflow, choose the safest decision, and explain why it is the most trustworthy SQL or data move.",
  "estimatedMinutes": 10,
  "learningObjectives": [
    "Clarify the stakeholder need behind lag and lead anomalies.",
  ...
  "scenarios": [
    {
      ...
      "id": "lag-lead-anomalies-scenario-1",
      "title": "Choose the strongest SQL approach",
      "context": "growth analyst needs a reliable answer for lag and lead anomalies before the weekly review. Pick the action that keeps the query auditable and the result grain stable under deadline pressure.",
      "displayFields": [
        {
          "label": "Dataset",
          "value": "mart.session_events"
        },
        {
          "label": "Deadline",
          "value": "30 minutes",
      ...
      "feedback": {
        "perfect": "Excellent. Lag and Lead Anomalies is strongest when you keep the grain explicit and validate the joins before sharing a metric.",
        ...
        "wrong": "That choice adds avoidable risk. For lag and lead anomalies, the best move is the option that stays reviewable and grain-aware."
      }
    },
    {
      "type": "action-rationale",
      "id": "lag-lead-anomalies-scenario-2",
      "title": "Handle the stakeholder follow-up",
      "context": "After your first draft, the growth analyst asks for one more slice of lag and lead anomalies by region. Decide how to respond without turning a clean query into a fragile one-off.",
      "displayFields": [
        {
          "label": "Current asset",
          "value": "lag-lead-anomalies_draft.sql"
        },
        {
    ...
    {
      "type": "action-rationale",
      "id": "lag-lead-anomalies-scenario-3",
      "title": "Explain why the result is trustworthy",
      "context": "You are presenting lag and lead anomalies in a team review. Choose the explanation that best demonstrates sound analytics judgment.",
      "displayFields": [
        {
          "label": "Audience",
  ...
  "hints": [
    "Start by naming the business grain that lag and lead anomalies should produce.",
  ...
  "careerInsight": "Analysts who can explain trends with clean SQL and defensible logic become the people leaders trust in decision meetings. Lag and Lead Anomalies is a common scenario in interviews, production reviews, and cross-functional planning.",
  "toolRelevance": [
    "DuckDB",
    "BigQuery",
    "Looker Studio"
