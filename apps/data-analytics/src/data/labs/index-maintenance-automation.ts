...
export const indexMaintenanceAutomationLab: LabManifest = LabManifestSchema.parse({
  "schemaVersion": "1.1",
  "id": "index-maintenance-automation",
  "version": 1,
  "title": "Index Maintenance Automation",
  "tier": "intermediate",
  ...
  "description": "Practice index maintenance automation inside a realistic analytics workflow, choose the safest decision, and explain why it is the most trustworthy SQL or data move.",
  "estimatedMinutes": 14,
  "learningObjectives": [
    "Clarify the stakeholder need behind index maintenance automation.",
  ...
  "scenarios": [
    {
      ...
      "id": "index-maintenance-automation-scenario-1",
      "title": "Choose the strongest SQL approach",
      "context": "platform SRE needs a reliable answer for index maintenance automation before the weekly review. Pick the action that keeps the query auditable and the result grain stable under deadline pressure.",
      "displayFields": [
        {
          "label": "Dataset",
          "value": "warehouse.compute_usage"
        },
        {
          "label": "Deadline",
          "value": "30 minutes",
      ...
      "feedback": {
        "perfect": "Excellent. Index Maintenance Automation is strongest when you keep the grain explicit and validate the joins before sharing a metric.",
        ...
        "wrong": "That choice adds avoidable risk. For index maintenance automation, the best move is the option that stays reviewable and grain-aware."
      }
    },
    {
      "type": "action-rationale",
      "id": "index-maintenance-automation-scenario-2",
      "title": "Handle the stakeholder follow-up",
      "context": "After your first draft, the platform SRE asks for one more slice of index maintenance automation by region. Decide how to respond without turning a clean query into a fragile one-off.",
      "displayFields": [
        {
          "label": "Current asset",
          "value": "index-maintenance-automation_draft.sql"
        },
        {
    ...
    {
      "type": "action-rationale",
      "id": "index-maintenance-automation-scenario-3",
      "title": "Explain why the result is trustworthy",
      "context": "You are presenting index maintenance automation in a team review. Choose the explanation that best demonstrates sound analytics judgment.",
      "displayFields": [
        {
          "label": "Audience",
  ...
  "hints": [
    "Start by naming the business grain that index maintenance automation should produce.",
  ...
  "careerInsight": "Advanced analytics work often separates solid SQL users from the engineers who can keep an entire warehouse fast and stable. Index Maintenance Automation is a common scenario in interviews, production reviews, and cross-functional planning.",
  "toolRelevance": [
    "EXPLAIN plans",
    "Snowflake",
    "PostgreSQL"
