...
export const entityRelationshipMappingLab: LabManifest = LabManifestSchema.parse({
  "schemaVersion": "1.1",
  "id": "entity-relationship-mapping",
  "version": 1,
  ...
  "description": "Practice entity relationship mapping inside a realistic analytics workflow, choose the safest decision, and explain why it is the most trustworthy SQL or data move.",
  "estimatedMinutes": 10,
  "learningObjectives": [
    "Clarify the stakeholder need behind entity relationship mapping.",
  ...
  "scenarios": [
    {
      "type": "toggle-config",
      "id": "entity-relationship-mapping-scenario-1",
      "title": "Configure the default quality controls",
      "description": "You are preparing a shared asset for entity relationship mapping. Set the defaults so the data architect gets trustworthy results without relying on tribal knowledge.",
      "targetSystem": "core.order_facts.semantic_model",
      "items": [
        {
          "id": "grain-check",
      ...
      "feedback": {
        "perfect": "Great configuration. Entity Relationship Mapping becomes safer to reuse when quality checks, null policies, and reviews are explicit.",
    ...
    {
      "type": "toggle-config",
      "id": "entity-relationship-mapping-scenario-2",
      "title": "Set access and change controls",
      "description": "A wider audience wants self-service access to entity relationship mapping. Configure the model so speed does not outrun governance.",
      "targetSystem": "core.order_facts.reporting_view",
      "items": [
        {
          "id": "access-scope",
          "label": "Access Scope",
    ...
    {
      "type": "toggle-config",
      "id": "entity-relationship-mapping-scenario-3",
      "title": "Tune the publish workflow",
      "description": "The team wants a faster release cycle for entity relationship mapping. Configure the publish workflow so the team can move quickly without normalizing broken output.",
      "targetSystem": "core.order_facts.publish_job",
      "items": [
        {
          "id": "test-suite",
  ...
  "hints": [
    "Start by naming the business grain that entity relationship mapping should produce.",
  ...
  "careerInsight": "Strong data modeling judgment helps teams avoid duplicated logic, brittle pipelines, and expensive rework. Entity Relationship Mapping is a common scenario in interviews, production reviews, and cross-functional planning.",
  "toolRelevance": [
    "dbdiagram.io",
    "PostgreSQL",
    "Flyway"
