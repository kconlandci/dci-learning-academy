...
export const caseExpressionsLab: LabManifest = LabManifestSchema.parse({
  "schemaVersion": "1.1",
  "id": "case-expressions",
  "version": 1,
  ...
  "description": "Practice case expressions inside a realistic analytics workflow, choose the safest decision, and explain why it is the most trustworthy SQL or data move.",
  "estimatedMinutes": 10,
  "learningObjectives": [
    "Clarify the stakeholder need behind case expressions.",
  ...
  "scenarios": [
    {
      "type": "toggle-config",
      "id": "case-expressions-scenario-1",
      "title": "Configure the default quality controls",
      "description": "You are preparing a shared asset for case expressions. Set the defaults so the operations manager gets trustworthy results without relying on tribal knowledge.",
      "targetSystem": "warehouse.orders.semantic_model",
      "items": [
        {
          "id": "grain-check",
      ...
      "feedback": {
        "perfect": "Great configuration. Case Expressions becomes safer to reuse when quality checks, null policies, and reviews are explicit.",
    ...
    {
      "type": "toggle-config",
      "id": "case-expressions-scenario-2",
      "title": "Set access and change controls",
      "description": "A wider audience wants self-service access to case expressions. Configure the model so speed does not outrun governance.",
      "targetSystem": "warehouse.orders.reporting_view",
      "items": [
        {
          "id": "access-scope",
          "label": "Access Scope",
    ...
    {
      "type": "toggle-config",
      "id": "case-expressions-scenario-3",
      "title": "Tune the publish workflow",
      "description": "The team wants a faster release cycle for case expressions. Configure the publish workflow so the team can move quickly without normalizing broken output.",
      "targetSystem": "warehouse.orders.publish_job",
      "items": [
        {
          "id": "test-suite",
  ...
  "hints": [
    "Start by naming the business grain that case expressions should produce.",
  ...
  "careerInsight": "Reliable SQL fundamentals are the fastest way to become useful on analytics, reporting, and data engineering teams. Case Expressions is a common scenario in interviews, production reviews, and cross-functional planning.",
  "toolRelevance": [
    "PostgreSQL",
    "SQLite",
    "DBeaver"
