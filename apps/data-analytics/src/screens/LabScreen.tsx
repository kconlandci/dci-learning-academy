    ...
    if (!recommendation) {
      return (
        <div className="bg-slate-800 rounded-xl p-4 text-center">
          <PartyPopper size={24} className="text-amber-400 mx-auto mb-2" />
    ...
    return (
      <div className="bg-slate-800 rounded-xl p-4">
        ...
        {isRecPremium ? (
          <button
            onClick={() => navigate("/upgrade")}
            className="flex items-center gap-2 px-4 py-2 rounded-lg bg-slate-700 text-amber-300 text-sm font-medium min-h-[44px]"
          >
