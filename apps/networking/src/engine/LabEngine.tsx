// ============================================================
// DCI Networking Labs — Shared Lab Engine
// ============================================================
...
export default function LabEngine({ manifest, renderer: Renderer, onExit, onLabComplete, onHintUsed, renderAfterResults }: LabEngineProps) {
        ...
        <div className="max-w-lg mx-auto pt-8">
          ...
          <div className="flex items-center gap-3 mb-6">
            <div className="w-12 h-12 rounded-xl bg-[#2A7F6F]/20 flex items-center justify-center">
              <Router className="text-[#2A7F6F]" size={24} />
            </div>
            <div>
      ...
      <div className="sticky top-0 z-10 bg-white/95 backdrop-blur border-b border-gray-200 px-4 py-3">
        <div className="max-w-lg mx-auto flex items-center justify-between">
          <div className="flex items-center gap-2">
            <Router size={18} className="text-[#2A7F6F]" />
