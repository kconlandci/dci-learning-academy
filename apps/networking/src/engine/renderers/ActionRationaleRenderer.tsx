...
const COLOR_MAP: Record<string, { selected: string; base: string }> = {
  blue:   { selected: "bg-blue-500/20 border-blue-500 text-blue-600", base: "bg-[#F5F5F5] border-gray-200 text-gray-600 hover:border-gray-300" },
  green:  { selected: "bg-green-500/20 border-green-500 text-green-600", base: "bg-[#F5F5F5] border-gray-200 text-gray-600 hover:border-gray-300" },
  yellow: { selected: "bg-yellow-500/20 border-yellow-500 text-yellow-600", base: "bg-[#F5F5F5] border-gray-200 text-gray-600 hover:border-gray-300" },
  orange: { selected: "bg-[#2A7F6F]/20 border-[#2A7F6F] text-[#2A7F6F]", base: "bg-[#F5F5F5] border-gray-200 text-gray-600 hover:border-gray-300" },
  red:    { selected: "bg-red-500/20 border-red-500 text-red-600", base: "bg-[#F5F5F5] border-gray-200 text-gray-600 hover:border-gray-300" },
};
