// Stubbed by scripts/rebrand.ts — gutted version of the original NetForge App.tsx.
...
function LazyFallback() {
  return (
    <div className="min-h-screen bg-white flex items-center justify-center">
      <div className="w-4 h-4 border-2 border-[#2A7F6F] border-t-transparent rounded-full animate-spin" />
    </div>
  );
}
