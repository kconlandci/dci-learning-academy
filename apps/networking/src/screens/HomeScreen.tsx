      ...
      <div className="min-h-screen bg-white p-4 pb-24">
        <div className="max-w-lg mx-auto pt-6">
          ...
          <div className="flex items-center gap-3 mb-4">
            <div className="w-10 h-10 rounded-xl bg-[#2A7F6F]/20 flex items-center justify-center">
              <Router className="text-[#2A7F6F]" size={22} />
            </div>
            <div>
          ...
          <div className="flex items-center gap-4 mb-6 px-1">
            ...
            {progress.streakDays > 0 && (
              <div className="flex items-center gap-1.5 text-xs text-gray-500">
                <Network size={12} className="text-[#2A7F6F]" />
          ...
          {allFreeComplete && !isPremium && (
            ...
            >
              <p className="text-sm text-[#2A7F6F] text-center">
                Ready for more? Unlock advanced labs with DCI Networking Labs
                Premium.
              </p>
            </Link>
          )}
          ...
          <section className="mb-8">
            ...
            {showAllLabs && (
              <>
                <h3 className="text-xs text-gray-500 mb-2 px-1">Free</h3>
                ...
                {premiumLabs.length > 0 && (
                  <>
                    <h3 className="text-xs text-gray-500 mb-2 px-1">
                      Premium
                    </h3>
...
function PathCard({
  ...
  const Icon = ICON_MAP[path.icon] || Router;
      ...
      >
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex items-center gap-2 mt-0.5">
            <span className="text-[10px] text-gray-500 capitalize">{diffBadge}</span>
            <span className="text-[10px] text-gray-500">
