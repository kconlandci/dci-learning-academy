// ============================================================
// DCI Networking Labs Dev Preview Screen — /dev
// ============================================================
    ...
    <div className="min-h-screen bg-white text-[#1A1A1A] p-4 pb-24">
      <div className="max-w-3xl mx-auto">
        <div className="flex items-center justify-between mb-6">
          <div>
            <h1 className="text-lg font-bold text-[#1A1A1A]">DCI Networking Scenarios Dev Preview</h1>
            <p className="text-xs text-gray-400">{labCatalog.length} manifests loaded</p>
          </div>
        ...
        <div className="bg-[#1E293B] border border-gray-600 rounded-lg p-4 mb-6 space-y-4">
          ...
          <div>
            <h3 className="text-[10px] font-bold text-gray-500 uppercase mb-1">By Renderer ({totalScenarios} total scenarios)</h3>
          ...
          <div>
            <h3 className="text-[10px] font-bold text-gray-500 uppercase mb-1">By Difficulty</h3>
            <div className="flex flex-wrap gap-2">
              {Object.entries(difficultyCounts).map(([k, v]) => (
                <span key={k} className="px-2 py-1 rounded text-xs font-mono bg-gray-700 text-gray-300">
                  {k}: {v}
                </span>
              ))}
            </div>
          ...
          <div>
            <h3 className="text-[10px] font-bold text-gray-500 uppercase mb-1">By Track</h3>
            <div className="flex flex-wrap gap-2">
          ...
          <div>
            <h3 className="text-[10px] font-bold text-gray-500 uppercase mb-1">By Access Level</h3>
            <div className="flex flex-wrap gap-2">
