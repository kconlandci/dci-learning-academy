...
export default function SettingsScreen() {
  ...
  const handleSendFeedback = () => {
    Browser.open({
      url: "mailto:dci-networking.app@gmail.com?subject=DCI Networking Scenarios%20Feedback",
    }).catch(() => {
      window.location.href = "mailto:dci-networking.app@gmail.com?subject=DCI Networking Scenarios%20Feedback";
    });
  };
      ...
      <div className="max-w-lg mx-auto pt-6">
        <div className="text-center mb-8">
          <img
            ...
            alt="DCI Networking Scenarios"
            className="w-14 h-14 rounded-2xl mx-auto mb-3"
          />
          <h1 className="text-xl font-bold text-[#1A1A1A]">DCI Networking Scenarios</h1>
          <p className="text-xs text-gray-500 mt-1">
            Network Judgment Training
          </p>
          <p className="text-[10px] text-gray-500 mt-1">v1.0.0</p>
          <p className="text-xs text-gray-500 mt-3 max-w-xs mx-auto leading-relaxed">
            Practice real-world network engineering judgment through interactive
            simulations.
          </p>
        </div>

        <section className="mb-6">
          <h2 className="text-[10px] font-semibold text-gray-500 uppercase tracking-wide mb-2 px-1">
            Premium
          </h2>
          <Link
            to="/upgrade"
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <span className="text-sm font-medium text-[#1A1A1A]">
                DCI Networking Scenarios Premium
              </span>
            </div>
        ...
        <section>
          ...
          <div className="space-y-1">
            ...
            <button
              onClick={() =>
                Browser.open({
                  url: "https://play.google.com/store/apps/details?id=com.dci-networking.app",
                }).catch(() => {
                  window.location.href = "https://play.google.com/store/apps/details?id=com.dci-networking.app";
                })
              }
              className="flex items-center gap-3 w-full bg-[#F5F5F5] rounded-xl p-4 min-h-[48px] active:bg-gray-200 transition-colors text-left"
            >
