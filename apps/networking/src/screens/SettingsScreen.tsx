...
export default function SettingsScreen() {
  ...
  const handleSendFeedback = () => {
    Browser.open({
      url: "mailto:dci-networking.app@gmail.com?subject=DCI Networking Labs%20Feedback",
    }).catch(() => {
      window.location.href = "mailto:dci-networking.app@gmail.com?subject=DCI Networking Labs%20Feedback";
    });
  };
