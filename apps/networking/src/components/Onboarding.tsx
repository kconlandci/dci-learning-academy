// ============================================================
// DCI Networking Labs — Onboarding Overlay
// Shows on first visit. 3 screens with dot nav.
// ============================================================

import { useState } from "react";
import { Eye, Hand, CheckCircle, Router } from "lucide-react";

const ONBOARDING_KEY = "dci-networking_onboarding_complete";
...
const screens: OnboardingScreen[] = [
  {
    title: "Welcome to DCI Networking Labs",
    body: "Practice real networking judgment in short, interactive scenarios.",
    icon: (
      <div className="w-20 h-20 rounded-2xl bg-[#2A7F6F]/10 flex items-center justify-center mb-4">
        <Router className="text-[#2A7F6F]" size={40} />
      </div>
    ),
  },
  {
  ...
  },
  {
    ...
    body: "DCI Networking Labs is for educational purposes only. Scenarios are simulated and designed to build network engineering judgment. Begin with a free beginner lab — no account needed.",
    icon: null,
    isFinal: true,
